...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/windows_web_app_slot
...
export class WindowsWebAppSlot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WindowsWebAppSlot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/windows_web_app_slot#import import section} in the documentation of this resource for the id to use
