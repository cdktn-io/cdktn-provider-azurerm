...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/cdn_frontdoor_rule
...
export class CdnFrontdoorRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnFrontdoorRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/cdn_frontdoor_rule#import import section} in the documentation of this resource for the id to use
