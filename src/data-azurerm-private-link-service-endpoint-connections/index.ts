...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/data-sources/private_link_service_endpoint_connections
...
export class DataAzurermPrivateLinkServiceEndpointConnections extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermPrivateLinkServiceEndpointConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/data-sources/private_link_service_endpoint_connections#import import section} in the documentation of this resource for the id to use
