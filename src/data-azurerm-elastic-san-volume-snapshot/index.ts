...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/data-sources/elastic_san_volume_snapshot
...
export class DataAzurermElasticSanVolumeSnapshot extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermElasticSanVolumeSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/data-sources/elastic_san_volume_snapshot#import import section} in the documentation of this resource for the id to use
