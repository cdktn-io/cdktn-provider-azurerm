...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/cognitive_account_connection_account_key
...
export class CognitiveAccountConnectionAccountKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitiveAccountConnectionAccountKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/cognitive_account_connection_account_key#import import section} in the documentation of this resource for the id to use
