...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/resources/bot_service_azure_bot
...
export class BotServiceAzureBot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BotServiceAzureBot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/resources/bot_service_azure_bot#import import section} in the documentation of this resource for the id to use
