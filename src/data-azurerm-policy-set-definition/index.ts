...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/policy_set_definition
...
export class DataAzurermPolicySetDefinition extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermPolicySetDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/policy_set_definition#import import section} in the documentation of this resource for the id to use
