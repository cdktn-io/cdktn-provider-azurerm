...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.66.0/docs/resources/web_pubsub_network_acl
...
export class WebPubsubNetworkAcl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WebPubsubNetworkAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.66.0/docs/resources/web_pubsub_network_acl#import import section} in the documentation of this resource for the id to use
