...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/data-sources/app_configuration_key
...
export class DataAzurermAppConfigurationKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermAppConfigurationKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/data-sources/app_configuration_key#import import section} in the documentation of this resource for the id to use
