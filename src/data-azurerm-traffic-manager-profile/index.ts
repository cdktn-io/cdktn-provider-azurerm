...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/traffic_manager_profile
...
export class DataAzurermTrafficManagerProfile extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermTrafficManagerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/traffic_manager_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/traffic_manager_profile azurerm_traffic_manager_profile} Data Source
  *
  * @param scope The scope in which to define this construct
