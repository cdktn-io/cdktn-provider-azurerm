...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/resources/vmware_private_cloud
...
export class VmwarePrivateCloud extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VmwarePrivateCloud that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/resources/vmware_private_cloud#import import section} in the documentation of this resource for the id to use
