...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.76.0/docs/resources/stream_analytics_output_cosmosdb
...
export class StreamAnalyticsOutputCosmosdb extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamAnalyticsOutputCosmosdb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.76.0/docs/resources/stream_analytics_output_cosmosdb#import import section} in the documentation of this resource for the id to use
