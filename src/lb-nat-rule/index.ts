...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/resources/lb_nat_rule
...
export class LbNatRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LbNatRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/resources/lb_nat_rule#import import section} in the documentation of this resource for the id to use
