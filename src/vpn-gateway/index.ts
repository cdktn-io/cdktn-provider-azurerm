...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway
...
export interface VpnGatewayConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#bgp_route_translation_for_nat_enabled VpnGateway#bgp_route_translation_for_nat_enabled}
  */
  readonly bgpRouteTranslationForNatEnabled?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#id VpnGateway#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#location VpnGateway#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#name VpnGateway#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#resource_group_name VpnGateway#resource_group_name}
  */
  readonly resourceGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#routing_preference VpnGateway#routing_preference}
  */
  readonly routingPreference?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#scale_unit VpnGateway#scale_unit}
  */
  readonly scaleUnit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#tags VpnGateway#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#virtual_hub_id VpnGateway#virtual_hub_id}
  */
  readonly virtualHubId: string;
  /**
  * bgp_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#bgp_settings VpnGateway#bgp_settings}
  */
  readonly bgpSettings?: VpnGatewayBgpSettings;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#timeouts VpnGateway#timeouts}
  */
...
export function vpnGatewayIpConfigurationToTerraform(struct?: VpnGatewayIpConfiguration): any {
...
export function vpnGatewayIpConfigurationToHclTerraform(struct?: VpnGatewayIpConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class VpnGatewayIpConfigurationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): VpnGatewayIpConfiguration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: VpnGatewayIpConfiguration | undefined) {
    if (value === undefined) {
...
export class VpnGatewayIpConfigurationList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): VpnGatewayIpConfigurationOutputReference {
    return new VpnGatewayIpConfigurationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface VpnGatewayBgpSettingsInstance0BgpPeeringAddress {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#custom_ips VpnGateway#custom_ips}
  */
...
export function vpnGatewayBgpSettingsInstance0BgpPeeringAddressToTerraform(struct?: VpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference | VpnGatewayBgpSettingsInstance0BgpPeeringAddress): any {
  ...
  return {
    custom_ips: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.customIps),
  }
}
...
export function vpnGatewayBgpSettingsInstance0BgpPeeringAddressToHclTerraform(struct?: VpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference | VpnGatewayBgpSettingsInstance0BgpPeeringAddress): any {
  ...
  const attrs = {
    custom_ips: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.customIps),
      isBlock: false,
      type: "set",
...
export class VpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get customIps() {
    return cdktn.Fn.tolist(this.getListAttribute('custom_ips'));
  }
  ...
  public get defaultIps() {
    return cdktn.Fn.tolist(this.getListAttribute('default_ips'));
  }
  ...
  public get tunnelIps() {
    return cdktn.Fn.tolist(this.getListAttribute('tunnel_ips'));
  }
}
...
export class VpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface VpnGatewayBgpSettings {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#asn VpnGateway#asn}
  */
  readonly asn: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#peer_weight VpnGateway#peer_weight}
  */
  readonly peerWeight: number;
  /**
  * instance_0_bgp_peering_address block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#instance_0_bgp_peering_address VpnGateway#instance_0_bgp_peering_address}
  */
  readonly instance0BgpPeeringAddress?: VpnGatewayBgpSettingsInstance0BgpPeeringAddress;
  /**
  * instance_1_bgp_peering_address block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#instance_1_bgp_peering_address VpnGateway#instance_1_bgp_peering_address}
  */
...
export function vpnGatewayBgpSettingsToTerraform(struct?: VpnGatewayBgpSettingsOutputReference | VpnGatewayBgpSettings): any {
  ...
  return {
    ...
    peer_weight: cdktn.numberToTerraform(struct!.peerWeight),
...
export function vpnGatewayBgpSettingsToHclTerraform(struct?: VpnGatewayBgpSettingsOutputReference | VpnGatewayBgpSettings): any {
  ...
  const attrs = {
    ...
    peer_weight: {
      value: cdktn.numberToHclTerraform(struct!.peerWeight),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class VpnGatewayBgpSettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface VpnGatewayTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#create VpnGateway#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#delete VpnGateway#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#read VpnGateway#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#update VpnGateway#update}
  */
  readonly update?: string;
}

export function vpnGatewayTimeoutsToTerraform(struct?: VpnGatewayTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function vpnGatewayTimeoutsToHclTerraform(struct?: VpnGatewayTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class VpnGatewayTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): VpnGatewayTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: VpnGatewayTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway azurerm_vpn_gateway}
*/
export class VpnGateway extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the VpnGateway to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_vpn_gateway", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/vpn_gateway azurerm_vpn_gateway} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _bgpRouteTranslationForNatEnabled?: boolean | cdktn.IResolvable; 
  public get bgpRouteTranslationForNatEnabled() {
    return this.getBooleanAttribute('bgp_route_translation_for_nat_enabled');
  }
  public set bgpRouteTranslationForNatEnabled(value: boolean | cdktn.IResolvable) {
  ...
  private _ipConfiguration = new VpnGatewayIpConfigurationList(this, "ip_configuration", false);
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      bgp_route_translation_for_nat_enabled: cdktn.booleanToTerraform(this._bgpRouteTranslationForNatEnabled),
      id: cdktn.stringToTerraform(this._id),
      location: cdktn.stringToTerraform(this._location),
      name: cdktn.stringToTerraform(this._name),
      resource_group_name: cdktn.stringToTerraform(this._resourceGroupName),
      routing_preference: cdktn.stringToTerraform(this._routingPreference),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      bgp_route_translation_for_nat_enabled: {
        value: cdktn.booleanToHclTerraform(this._bgpRouteTranslationForNatEnabled),
        isBlock: false,
        type: "simple",
      ...
      routing_preference: {
        value: cdktn.stringToHclTerraform(this._routingPreference),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
