...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.68.0/docs/resources/active_directory_domain_service
...
export class ActiveDirectoryDomainService extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ActiveDirectoryDomainService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.68.0/docs/resources/active_directory_domain_service#import import section} in the documentation of this resource for the id to use
