...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/cognitive_account_connection_account_managed_identity
...
export class CognitiveAccountConnectionAccountManagedIdentity extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitiveAccountConnectionAccountManagedIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/cognitive_account_connection_account_managed_identity#import import section} in the documentation of this resource for the id to use
