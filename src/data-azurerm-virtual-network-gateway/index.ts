...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/data-sources/virtual_network_gateway
...
export class DataAzurermVirtualNetworkGateway extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermVirtualNetworkGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/data-sources/virtual_network_gateway#import import section} in the documentation of this resource for the id to use
