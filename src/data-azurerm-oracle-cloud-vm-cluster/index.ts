...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/data-sources/oracle_cloud_vm_cluster
...
export class DataAzurermOracleCloudVmCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOracleCloudVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/data-sources/oracle_cloud_vm_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/data-sources/oracle_cloud_vm_cluster azurerm_oracle_cloud_vm_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
