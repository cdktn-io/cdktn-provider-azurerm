...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.66.0/docs/resources/api_management_api_diagnostic
...
export class ApiManagementApiDiagnostic extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagementApiDiagnostic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.66.0/docs/resources/api_management_api_diagnostic#import import section} in the documentation of this resource for the id to use
