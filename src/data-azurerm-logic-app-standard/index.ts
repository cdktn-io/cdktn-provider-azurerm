...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/logic_app_standard
...
export class DataAzurermLogicAppStandard extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermLogicAppStandard that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/logic_app_standard#import import section} in the documentation of this resource for the id to use
