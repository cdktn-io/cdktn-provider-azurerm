...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/api_management_api_tag_description
...
export class ApiManagementApiTagDescription extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagementApiTagDescription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/api_management_api_tag_description#import import section} in the documentation of this resource for the id to use
