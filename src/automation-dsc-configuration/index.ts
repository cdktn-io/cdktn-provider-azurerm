...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/automation_dsc_configuration
...
export class AutomationDscConfiguration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomationDscConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/automation_dsc_configuration#import import section} in the documentation of this resource for the id to use
