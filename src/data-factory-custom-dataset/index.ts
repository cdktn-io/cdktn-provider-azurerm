...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/data_factory_custom_dataset
...
export interface DataFactoryCustomDatasetConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataFactoryCustomDatasetLinkedServiceOutputReference extends cdktn.ComplexObject {
...
export function dataFactoryCustomDatasetTimeoutsToTerraform(struct?: DataFactoryCustomDatasetTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataFactoryCustomDatasetTimeoutsToHclTerraform(struct?: DataFactoryCustomDatasetTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataFactoryCustomDatasetTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataFactoryCustomDatasetTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataFactoryCustomDatasetTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataFactoryCustomDataset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataFactoryCustomDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/data_factory_custom_dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_data_factory_custom_dataset", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/data_factory_custom_dataset azurerm_data_factory_custom_dataset} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      schema_json: cdktn.stringToTerraform(this._schemaJson),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      schema_json: {
        value: cdktn.stringToHclTerraform(this._schemaJson),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
