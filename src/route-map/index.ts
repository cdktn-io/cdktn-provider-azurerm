...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/resources/route_map
...
export class RouteMap extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RouteMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/resources/route_map#import import section} in the documentation of this resource for the id to use
