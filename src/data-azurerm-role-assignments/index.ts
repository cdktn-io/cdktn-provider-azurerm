...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments
...
export interface DataAzurermRoleAssignmentsConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments#id DataAzurermRoleAssignments#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments#limit_at_scope DataAzurermRoleAssignments#limit_at_scope}
  */
  readonly limitAtScope?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments#principal_id DataAzurermRoleAssignments#principal_id}
  */
  readonly principalId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments#scope DataAzurermRoleAssignments#scope}
  */
  readonly scope: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments#tenant_id DataAzurermRoleAssignments#tenant_id}
  */
  readonly tenantId?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments#timeouts DataAzurermRoleAssignments#timeouts}
  */
...
export interface DataAzurermRoleAssignmentsTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments#read DataAzurermRoleAssignments#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments azurerm_role_assignments}
*/
export class DataAzurermRoleAssignments extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermRoleAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/data-sources/role_assignments azurerm_role_assignments} Data Source
  *
  * @param scope The scope in which to define this construct
