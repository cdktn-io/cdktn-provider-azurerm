...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/resources/arc_kubernetes_cluster
...
export class ArcKubernetesCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ArcKubernetesCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/resources/arc_kubernetes_cluster#import import section} in the documentation of this resource for the id to use
