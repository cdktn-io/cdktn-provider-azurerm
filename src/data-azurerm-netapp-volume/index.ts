...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.60.0/docs/data-sources/netapp_volume
...
export class DataAzurermNetappVolume extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNetappVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.60.0/docs/data-sources/netapp_volume#import import section} in the documentation of this resource for the id to use
