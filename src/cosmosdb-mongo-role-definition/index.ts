...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/resources/cosmosdb_mongo_role_definition
...
export class CosmosdbMongoRoleDefinition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CosmosdbMongoRoleDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/resources/cosmosdb_mongo_role_definition#import import section} in the documentation of this resource for the id to use
