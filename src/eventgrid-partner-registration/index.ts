...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/eventgrid_partner_registration
...
export class EventgridPartnerRegistration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventgridPartnerRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/eventgrid_partner_registration#import import section} in the documentation of this resource for the id to use
