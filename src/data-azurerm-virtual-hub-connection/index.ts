...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/virtual_hub_connection
...
export interface DataAzurermVirtualHubConnectionConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataAzurermVirtualHubConnectionRoutingPropagatedRouteTableOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermVirtualHubConnectionRoutingPropagatedRouteTableList extends cdktn.ComplexList {
...
export class DataAzurermVirtualHubConnectionRoutingStaticVnetRouteOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVirtualHubConnectionRoutingStaticVnetRouteList extends cdktn.ComplexList {
...
export class DataAzurermVirtualHubConnectionRoutingOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVirtualHubConnectionRoutingList extends cdktn.ComplexList {
...
export function dataAzurermVirtualHubConnectionTimeoutsToTerraform(struct?: DataAzurermVirtualHubConnectionTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAzurermVirtualHubConnectionTimeoutsToHclTerraform(struct?: DataAzurermVirtualHubConnectionTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurermVirtualHubConnectionTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermVirtualHubConnectionTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermVirtualHubConnectionTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataAzurermVirtualHubConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermVirtualHubConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/virtual_hub_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/virtual_hub_connection azurerm_virtual_hub_connection} Data Source
  *
  * @param scope The scope in which to define this construct
