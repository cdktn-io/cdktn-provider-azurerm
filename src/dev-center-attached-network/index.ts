...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/dev_center_attached_network
...
export class DevCenterAttachedNetwork extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DevCenterAttachedNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/dev_center_attached_network#import import section} in the documentation of this resource for the id to use
