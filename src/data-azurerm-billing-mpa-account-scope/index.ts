...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/billing_mpa_account_scope
...
export class DataAzurermBillingMpaAccountScope extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermBillingMpaAccountScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/billing_mpa_account_scope#import import section} in the documentation of this resource for the id to use
