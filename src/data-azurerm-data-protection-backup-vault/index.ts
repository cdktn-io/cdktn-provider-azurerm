...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/data_protection_backup_vault
...
export class DataAzurermDataProtectionBackupVault extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermDataProtectionBackupVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/data_protection_backup_vault#import import section} in the documentation of this resource for the id to use
