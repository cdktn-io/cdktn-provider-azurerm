...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/resources/oracle_autonomous_database_clone_from_database
...
export interface OracleAutonomousDatabaseCloneFromDatabaseConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function oracleAutonomousDatabaseCloneFromDatabaseTimeoutsToTerraform(struct?: OracleAutonomousDatabaseCloneFromDatabaseTimeouts | cdktn.IResolvable): any {
...
export function oracleAutonomousDatabaseCloneFromDatabaseTimeoutsToHclTerraform(struct?: OracleAutonomousDatabaseCloneFromDatabaseTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OracleAutonomousDatabaseCloneFromDatabaseTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OracleAutonomousDatabaseCloneFromDatabaseTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: OracleAutonomousDatabaseCloneFromDatabaseTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class OracleAutonomousDatabaseCloneFromDatabase extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OracleAutonomousDatabaseCloneFromDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/resources/oracle_autonomous_database_clone_from_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/resources/oracle_autonomous_database_clone_from_database azurerm_oracle_autonomous_database_clone_from_database} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      refreshable_model: cdktn.stringToTerraform(this._refreshableModel),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      refreshable_model: {
        value: cdktn.stringToHclTerraform(this._refreshableModel),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
