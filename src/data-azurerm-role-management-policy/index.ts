...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/role_management_policy
...
export class DataAzurermRoleManagementPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermRoleManagementPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/role_management_policy#import import section} in the documentation of this resource for the id to use
