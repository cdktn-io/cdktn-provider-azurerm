...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/resources/private_endpoint
...
export class PrivateEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/resources/private_endpoint#import import section} in the documentation of this resource for the id to use
