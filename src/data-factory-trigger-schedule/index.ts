...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/data_factory_trigger_schedule
...
export class DataFactoryTriggerSchedule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataFactoryTriggerSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/data_factory_trigger_schedule#import import section} in the documentation of this resource for the id to use
