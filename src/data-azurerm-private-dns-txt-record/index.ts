...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/private_dns_txt_record
...
export class DataAzurermPrivateDnsTxtRecord extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermPrivateDnsTxtRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/private_dns_txt_record#import import section} in the documentation of this resource for the id to use
