...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/frontdoor_custom_https_configuration
...
export interface FrontdoorCustomHttpsConfigurationConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly customHttpsProvisioningEnabled: boolean | cdktn.IResolvable;
  /**
...
export function frontdoorCustomHttpsConfigurationCustomHttpsConfigurationToTerraform(struct?: FrontdoorCustomHttpsConfigurationCustomHttpsConfigurationOutputReference | FrontdoorCustomHttpsConfigurationCustomHttpsConfiguration): any {
  ...
  return {
    azure_key_vault_certificate_secret_name: cdktn.stringToTerraform(struct!.azureKeyVaultCertificateSecretName),
    azure_key_vault_certificate_secret_version: cdktn.stringToTerraform(struct!.azureKeyVaultCertificateSecretVersion),
    azure_key_vault_certificate_vault_id: cdktn.stringToTerraform(struct!.azureKeyVaultCertificateVaultId),
    certificate_source: cdktn.stringToTerraform(struct!.certificateSource),
  }
}
...
export function frontdoorCustomHttpsConfigurationCustomHttpsConfigurationToHclTerraform(struct?: FrontdoorCustomHttpsConfigurationCustomHttpsConfigurationOutputReference | FrontdoorCustomHttpsConfigurationCustomHttpsConfiguration): any {
  ...
  const attrs = {
    azure_key_vault_certificate_secret_name: {
      value: cdktn.stringToHclTerraform(struct!.azureKeyVaultCertificateSecretName),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    azure_key_vault_certificate_secret_version: {
      value: cdktn.stringToHclTerraform(struct!.azureKeyVaultCertificateSecretVersion),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    azure_key_vault_certificate_vault_id: {
      value: cdktn.stringToHclTerraform(struct!.azureKeyVaultCertificateVaultId),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    certificate_source: {
      value: cdktn.stringToHclTerraform(struct!.certificateSource),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class FrontdoorCustomHttpsConfigurationCustomHttpsConfigurationOutputReference extends cdktn.ComplexObject {
...
export function frontdoorCustomHttpsConfigurationTimeoutsToTerraform(struct?: FrontdoorCustomHttpsConfigurationTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function frontdoorCustomHttpsConfigurationTimeoutsToHclTerraform(struct?: FrontdoorCustomHttpsConfigurationTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class FrontdoorCustomHttpsConfigurationTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): FrontdoorCustomHttpsConfigurationTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: FrontdoorCustomHttpsConfigurationTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class FrontdoorCustomHttpsConfiguration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FrontdoorCustomHttpsConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/frontdoor_custom_https_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_frontdoor_custom_https_configuration", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/frontdoor_custom_https_configuration azurerm_frontdoor_custom_https_configuration} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _customHttpsProvisioningEnabled?: boolean | cdktn.IResolvable; 
  public get customHttpsProvisioningEnabled() {
    return this.getBooleanAttribute('custom_https_provisioning_enabled');
  }
  public set customHttpsProvisioningEnabled(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      custom_https_provisioning_enabled: cdktn.booleanToTerraform(this._customHttpsProvisioningEnabled),
      frontend_endpoint_id: cdktn.stringToTerraform(this._frontendEndpointId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      custom_https_provisioning_enabled: {
        value: cdktn.booleanToHclTerraform(this._customHttpsProvisioningEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      frontend_endpoint_id: {
        value: cdktn.stringToHclTerraform(this._frontendEndpointId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
