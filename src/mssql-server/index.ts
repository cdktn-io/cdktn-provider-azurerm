...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/mssql_server
...
export class MssqlServer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MssqlServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/mssql_server#import import section} in the documentation of this resource for the id to use
