...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/data-sources/oracle_database_system_versions
...
export class DataAzurermOracleDatabaseSystemVersions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOracleDatabaseSystemVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/data-sources/oracle_database_system_versions#import import section} in the documentation of this resource for the id to use
