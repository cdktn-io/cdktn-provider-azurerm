...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/synapse_sql_pool
...
export class SynapseSqlPool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SynapseSqlPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/synapse_sql_pool#import import section} in the documentation of this resource for the id to use
