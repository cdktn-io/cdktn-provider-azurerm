...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/elastic_san_volume
...
export class ElasticSanVolume extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticSanVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/elastic_san_volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/elastic_san_volume azurerm_elastic_san_volume} Resource
  *
  * @param scope The scope in which to define this construct
