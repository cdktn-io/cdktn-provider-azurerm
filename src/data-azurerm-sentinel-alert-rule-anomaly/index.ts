...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/sentinel_alert_rule_anomaly
...
export interface DataAzurermSentinelAlertRuleAnomalyConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/sentinel_alert_rule_anomaly#display_name DataAzurermSentinelAlertRuleAnomaly#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/sentinel_alert_rule_anomaly#id DataAzurermSentinelAlertRuleAnomaly#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/sentinel_alert_rule_anomaly#log_analytics_workspace_id DataAzurermSentinelAlertRuleAnomaly#log_analytics_workspace_id}
  */
  readonly logAnalyticsWorkspaceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/sentinel_alert_rule_anomaly#name DataAzurermSentinelAlertRuleAnomaly#name}
  */
  readonly name?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/sentinel_alert_rule_anomaly#timeouts DataAzurermSentinelAlertRuleAnomaly#timeouts}
  */
...
export class DataAzurermSentinelAlertRuleAnomalyMultiSelectObservationOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermSentinelAlertRuleAnomalyMultiSelectObservationList extends cdktn.ComplexList {
...
export class DataAzurermSentinelAlertRuleAnomalyPrioritizedExcludeObservationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermSentinelAlertRuleAnomalyPrioritizedExcludeObservationList extends cdktn.ComplexList {
...
export class DataAzurermSentinelAlertRuleAnomalyRequiredDataConnectorOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermSentinelAlertRuleAnomalyRequiredDataConnectorList extends cdktn.ComplexList {
...
export class DataAzurermSentinelAlertRuleAnomalySingleSelectObservationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermSentinelAlertRuleAnomalySingleSelectObservationList extends cdktn.ComplexList {
...
export class DataAzurermSentinelAlertRuleAnomalyThresholdObservationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermSentinelAlertRuleAnomalyThresholdObservationList extends cdktn.ComplexList {
...
export interface DataAzurermSentinelAlertRuleAnomalyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/sentinel_alert_rule_anomaly#read DataAzurermSentinelAlertRuleAnomaly#read}
  */
  readonly read?: string;
}

export function dataAzurermSentinelAlertRuleAnomalyTimeoutsToTerraform(struct?: DataAzurermSentinelAlertRuleAnomalyTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAzurermSentinelAlertRuleAnomalyTimeoutsToHclTerraform(struct?: DataAzurermSentinelAlertRuleAnomalyTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermSentinelAlertRuleAnomalyTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermSentinelAlertRuleAnomalyTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermSentinelAlertRuleAnomalyTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/sentinel_alert_rule_anomaly azurerm_sentinel_alert_rule_anomaly}
*/
export class DataAzurermSentinelAlertRuleAnomaly extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataAzurermSentinelAlertRuleAnomaly resource upon running "cdktn plan <stack-name>"
  ...
  * @param importFromId The id of the existing DataAzurermSentinelAlertRuleAnomaly that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/sentinel_alert_rule_anomaly#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_sentinel_alert_rule_anomaly", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/sentinel_alert_rule_anomaly azurerm_sentinel_alert_rule_anomaly} Data Source
  *
  * @param scope The scope in which to define this construct
