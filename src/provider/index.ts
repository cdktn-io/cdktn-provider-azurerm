...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs
...
export class AzurermProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing AzurermProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs azurerm} Resource
  *
  * @param scope The scope in which to define this construct
