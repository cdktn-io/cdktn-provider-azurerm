...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.67.0/docs
...
export class AzurermProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing AzurermProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.67.0/docs#import import section} in the documentation of this resource for the id to use
