...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/api_management_gateway_host_name_configuration
...
export class DataAzurermApiManagementGatewayHostNameConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermApiManagementGatewayHostNameConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/api_management_gateway_host_name_configuration#import import section} in the documentation of this resource for the id to use
