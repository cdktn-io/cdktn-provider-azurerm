...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/dev_center_project_pool
...
export interface DataAzurermDevCenterProjectPoolConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function dataAzurermDevCenterProjectPoolTimeoutsToTerraform(struct?: DataAzurermDevCenterProjectPoolTimeouts | cdktn.IResolvable): any {
...
export function dataAzurermDevCenterProjectPoolTimeoutsToHclTerraform(struct?: DataAzurermDevCenterProjectPoolTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurermDevCenterProjectPoolTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDevCenterProjectPoolTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermDevCenterProjectPoolTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataAzurermDevCenterProjectPool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermDevCenterProjectPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/dev_center_project_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/dev_center_project_pool azurerm_dev_center_project_pool} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // single_sign_on_enabled - computed: true, optional: false, required: false
