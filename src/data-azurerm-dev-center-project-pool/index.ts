...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/dev_center_project_pool
...
export class DataAzurermDevCenterProjectPool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermDevCenterProjectPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/dev_center_project_pool#import import section} in the documentation of this resource for the id to use
