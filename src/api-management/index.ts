...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/resources/api_management
...
export class ApiManagement extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/resources/api_management#import import section} in the documentation of this resource for the id to use
