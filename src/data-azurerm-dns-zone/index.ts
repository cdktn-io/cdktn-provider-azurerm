...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/data-sources/dns_zone
...
export class DataAzurermDnsZone extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermDnsZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/data-sources/dns_zone#import import section} in the documentation of this resource for the id to use
