...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/site_recovery_protection_container
...
export class DataAzurermSiteRecoveryProtectionContainer extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermSiteRecoveryProtectionContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/site_recovery_protection_container#import import section} in the documentation of this resource for the id to use
