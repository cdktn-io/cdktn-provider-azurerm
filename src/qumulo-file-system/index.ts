...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/qumulo_file_system
...
export class QumuloFileSystem extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QumuloFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/qumulo_file_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/qumulo_file_system azurerm_qumulo_file_system} Resource
  *
  * @param scope The scope in which to define this construct
