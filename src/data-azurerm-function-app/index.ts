...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/data-sources/function_app
...
export class DataAzurermFunctionApp extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermFunctionApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/data-sources/function_app#import import section} in the documentation of this resource for the id to use
