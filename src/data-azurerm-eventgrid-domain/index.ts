...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/eventgrid_domain
...
export class DataAzurermEventgridDomainIdentityOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermEventgridDomainIdentityList extends cdktn.ComplexList {
...
export class DataAzurermEventgridDomainInboundIpRuleOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermEventgridDomainInboundIpRuleList extends cdktn.ComplexList {
...
export class DataAzurermEventgridDomainInputMappingDefaultValuesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermEventgridDomainInputMappingDefaultValuesList extends cdktn.ComplexList {
...
export class DataAzurermEventgridDomainInputMappingFieldsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermEventgridDomainInputMappingFieldsList extends cdktn.ComplexList {
...
export class DataAzurermEventgridDomainTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermEventgridDomainTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermEventgridDomainTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAzurermEventgridDomain extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermEventgridDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/eventgrid_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/eventgrid_domain azurerm_eventgrid_domain} Data Source
  *
  * @param scope The scope in which to define this construct
