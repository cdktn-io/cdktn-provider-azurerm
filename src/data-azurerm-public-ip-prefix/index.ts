...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/public_ip_prefix
...
export class DataAzurermPublicIpPrefix extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermPublicIpPrefix that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/public_ip_prefix#import import section} in the documentation of this resource for the id to use
