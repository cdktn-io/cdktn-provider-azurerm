...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/dns_mx_record
...
export class DnsMxRecord extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsMxRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/dns_mx_record#import import section} in the documentation of this resource for the id to use
