...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/linux_web_app
...
export class DataAzurermLinuxWebApp extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermLinuxWebApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/linux_web_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  // virtual_network_image_pull_enabled - computed: true, optional: false, required: false
