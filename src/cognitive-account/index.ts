...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.66.0/docs/resources/cognitive_account
...
export class CognitiveAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitiveAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.66.0/docs/resources/cognitive_account#import import section} in the documentation of this resource for the id to use
