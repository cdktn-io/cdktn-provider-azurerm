...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/monitor_aad_diagnostic_setting
...
export class MonitorAadDiagnosticSetting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorAadDiagnosticSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/monitor_aad_diagnostic_setting#import import section} in the documentation of this resource for the id to use
