...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/mongo_cluster
...
export interface MongoClusterConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly cosmosDbNetworkBypassEnabled?: boolean | cdktn.IResolvable;
  /**
...
export class MongoCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MongoCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/mongo_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/mongo_cluster azurerm_mongo_cluster} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: MongoClusterConfig) {
    ...
    this._cosmosDbNetworkBypassEnabled = config.cosmosDbNetworkBypassEnabled;
  ...
  // cosmos_db_network_bypass_enabled - computed: false, optional: true, required: false
  private _cosmosDbNetworkBypassEnabled?: boolean | cdktn.IResolvable; 
  public get cosmosDbNetworkBypassEnabled() {
    return this.getBooleanAttribute('cosmos_db_network_bypass_enabled');
  }
  public set cosmosDbNetworkBypassEnabled(value: boolean | cdktn.IResolvable) {
    this._cosmosDbNetworkBypassEnabled = value;
  }
  public resetCosmosDbNetworkBypassEnabled() {
    this._cosmosDbNetworkBypassEnabled = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get cosmosDbNetworkBypassEnabledInput() {
    return this._cosmosDbNetworkBypassEnabled;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      cosmos_db_network_bypass_enabled: cdktn.booleanToTerraform(this._cosmosDbNetworkBypassEnabled),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      cosmos_db_network_bypass_enabled: {
        value: cdktn.booleanToHclTerraform(this._cosmosDbNetworkBypassEnabled),
        isBlock: false,
        type: "simple",
