...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/managed_redis
...
export interface DataAzurermManagedRedisConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataAzurermManagedRedisCustomerManagedKeyOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermManagedRedisCustomerManagedKeyList extends cdktn.ComplexList {
...
export class DataAzurermManagedRedisDefaultDatabaseModuleOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermManagedRedisDefaultDatabaseModuleList extends cdktn.ComplexList {
...
export class DataAzurermManagedRedisDefaultDatabaseOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get geoReplicationLinkedDatabaseIds() {
    return cdktn.Fn.tolist(this.getListAttribute('geo_replication_linked_database_ids'));
  }
...
export class DataAzurermManagedRedisDefaultDatabaseList extends cdktn.ComplexList {
...
export class DataAzurermManagedRedisIdentityOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermManagedRedisIdentityList extends cdktn.ComplexList {
...
export function dataAzurermManagedRedisTimeoutsToTerraform(struct?: DataAzurermManagedRedisTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAzurermManagedRedisTimeoutsToHclTerraform(struct?: DataAzurermManagedRedisTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurermManagedRedisTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermManagedRedisTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermManagedRedisTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataAzurermManagedRedis extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermManagedRedis that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/managed_redis#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/managed_redis azurerm_managed_redis} Data Source
  *
  * @param scope The scope in which to define this construct
