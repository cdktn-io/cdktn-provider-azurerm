...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/data-sources/virtual_network_gateway_connection
...
export interface DataAzurermVirtualNetworkGatewayConnectionConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataAzurermVirtualNetworkGatewayConnectionIpsecPolicyOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermVirtualNetworkGatewayConnectionIpsecPolicyList extends cdktn.ComplexList {
...
export class DataAzurermVirtualNetworkGatewayConnectionTrafficSelectorPolicyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVirtualNetworkGatewayConnectionTrafficSelectorPolicyList extends cdktn.ComplexList {
...
export function dataAzurermVirtualNetworkGatewayConnectionTimeoutsToTerraform(struct?: DataAzurermVirtualNetworkGatewayConnectionTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAzurermVirtualNetworkGatewayConnectionTimeoutsToHclTerraform(struct?: DataAzurermVirtualNetworkGatewayConnectionTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermVirtualNetworkGatewayConnectionTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermVirtualNetworkGatewayConnectionTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermVirtualNetworkGatewayConnectionTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataAzurermVirtualNetworkGatewayConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermVirtualNetworkGatewayConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/data-sources/virtual_network_gateway_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/data-sources/virtual_network_gateway_connection azurerm_virtual_network_gateway_connection} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // bgp_enabled - computed: true, optional: false, required: false
