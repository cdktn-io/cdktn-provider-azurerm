...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/static_web_app_function_app_registration
...
export class StaticWebAppFunctionAppRegistration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StaticWebAppFunctionAppRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/static_web_app_function_app_registration#import import section} in the documentation of this resource for the id to use
