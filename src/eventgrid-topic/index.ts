...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/eventgrid_topic
...
export class EventgridTopic extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventgridTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/eventgrid_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/eventgrid_topic azurerm_eventgrid_topic} Resource
  *
  * @param scope The scope in which to define this construct
