...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/disk_access
...
export class DiskAccess extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DiskAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/disk_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/disk_access azurerm_disk_access} Resource
  *
  * @param scope The scope in which to define this construct
