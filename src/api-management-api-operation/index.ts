...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/api_management_api_operation
...
export class ApiManagementApiOperation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagementApiOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/api_management_api_operation#import import section} in the documentation of this resource for the id to use
