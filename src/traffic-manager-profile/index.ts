...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.5.0/docs/resources/traffic_manager_profile
...
export class TrafficManagerProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TrafficManagerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.5.0/docs/resources/traffic_manager_profile#import import section} in the documentation of this resource for the id to use
