...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/data-sources/servicebus_topic
...
export class DataAzurermServicebusTopic extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermServicebusTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/data-sources/servicebus_topic#import import section} in the documentation of this resource for the id to use
