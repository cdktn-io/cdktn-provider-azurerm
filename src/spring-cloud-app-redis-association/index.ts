...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/spring_cloud_app_redis_association
...
export class SpringCloudAppRedisAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SpringCloudAppRedisAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/spring_cloud_app_redis_association#import import section} in the documentation of this resource for the id to use
