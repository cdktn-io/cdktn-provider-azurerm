...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/network_manager_connectivity_configuration
...
export class DataAzurermNetworkManagerConnectivityConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNetworkManagerConnectivityConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/network_manager_connectivity_configuration#import import section} in the documentation of this resource for the id to use
