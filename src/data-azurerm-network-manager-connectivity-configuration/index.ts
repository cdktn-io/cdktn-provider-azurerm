...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/network_manager_connectivity_configuration
...
export class DataAzurermNetworkManagerConnectivityConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNetworkManagerConnectivityConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/network_manager_connectivity_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  // connected_group_address_overlap_enabled - computed: true, optional: false, required: false
  public get connectedGroupAddressOverlapEnabled() {
    return this.getBooleanAttribute('connected_group_address_overlap_enabled');
  }

  // connected_group_private_endpoints_scale - computed: true, optional: false, required: false
  ...
  // peering_enforcement_enabled - computed: true, optional: false, required: false
