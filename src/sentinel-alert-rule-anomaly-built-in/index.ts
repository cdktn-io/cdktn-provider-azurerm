...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/resources/sentinel_alert_rule_anomaly_built_in
...
export class SentinelAlertRuleAnomalyBuiltIn extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SentinelAlertRuleAnomalyBuiltIn that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/resources/sentinel_alert_rule_anomaly_built_in#import import section} in the documentation of this resource for the id to use
