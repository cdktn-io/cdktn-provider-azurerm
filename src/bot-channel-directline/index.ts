...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/bot_channel_directline
...
export class BotChannelDirectline extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BotChannelDirectline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/bot_channel_directline#import import section} in the documentation of this resource for the id to use
