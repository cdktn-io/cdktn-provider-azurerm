...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_channel_directline
...
export class BotChannelDirectline extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BotChannelDirectline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_channel_directline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_channel_directline azurerm_bot_channel_directline} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // extension_key_1 - computed: true, optional: false, required: false
  public get extensionKey1() {
    return this.getStringAttribute('extension_key_1');
  }

  // extension_key_2 - computed: true, optional: false, required: false
  public get extensionKey2() {
    return this.getStringAttribute('extension_key_2');
  }
