...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/hdinsight_hbase_cluster
...
export class HdinsightHbaseCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing HdinsightHbaseCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/hdinsight_hbase_cluster#import import section} in the documentation of this resource for the id to use
