...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/cognitive_account_connection_entra_id
...
export interface CognitiveAccountConnectionEntraIdConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: CognitiveAccountConnectionEntraIdTimeouts;
}
export interface CognitiveAccountConnectionEntraIdTimeouts {
  /**
...
export function cognitiveAccountConnectionEntraIdTimeoutsToTerraform(struct?: CognitiveAccountConnectionEntraIdTimeouts | cdktn.IResolvable): any {
...
export function cognitiveAccountConnectionEntraIdTimeoutsToHclTerraform(struct?: CognitiveAccountConnectionEntraIdTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class CognitiveAccountConnectionEntraIdTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CognitiveAccountConnectionEntraIdTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: CognitiveAccountConnectionEntraIdTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class CognitiveAccountConnectionEntraId extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_cognitive_account_connection_entra_id";
  ...
  * @param importToId The construct id used in the generated config for the CognitiveAccountConnectionEntraId to import
  * @param importFromId The id of the existing CognitiveAccountConnectionEntraId that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/cognitive_account_connection_entra_id#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CognitiveAccountConnectionEntraId to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_cognitive_account_connection_entra_id", importId: importFromId, provider });
      }
  ...
  * @param options CognitiveAccountConnectionEntraIdConfig
  */
  public constructor(scope: Construct, id: string, config: CognitiveAccountConnectionEntraIdConfig) {
    super(scope, id, {
      terraformResourceType: 'azurerm_cognitive_account_connection_entra_id',
  ...
  private _timeouts = new CognitiveAccountConnectionEntraIdTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: CognitiveAccountConnectionEntraIdTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: cognitiveAccountConnectionEntraIdTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: cognitiveAccountConnectionEntraIdTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CognitiveAccountConnectionEntraIdTimeouts",
      },
    };
