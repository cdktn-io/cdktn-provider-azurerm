...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/elastic_san_volume_group
...
export class DataAzurermElasticSanVolumeGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermElasticSanVolumeGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/elastic_san_volume_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/elastic_san_volume_group azurerm_elastic_san_volume_group} Data Source
  *
  * @param scope The scope in which to define this construct
