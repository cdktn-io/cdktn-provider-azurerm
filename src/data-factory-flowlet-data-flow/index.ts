...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/resources/data_factory_flowlet_data_flow
...
export class DataFactoryFlowletDataFlow extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataFactoryFlowletDataFlow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.61.0/docs/resources/data_factory_flowlet_data_flow#import import section} in the documentation of this resource for the id to use
