...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/resources/network_manager_verifier_workspace_reachability_analysis_intent
...
export class NetworkManagerVerifierWorkspaceReachabilityAnalysisIntent extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkManagerVerifierWorkspaceReachabilityAnalysisIntent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/resources/network_manager_verifier_workspace_reachability_analysis_intent#import import section} in the documentation of this resource for the id to use
