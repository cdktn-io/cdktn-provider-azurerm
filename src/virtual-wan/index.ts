...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/resources/virtual_wan
...
export class VirtualWan extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualWan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/resources/virtual_wan#import import section} in the documentation of this resource for the id to use
