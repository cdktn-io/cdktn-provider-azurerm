...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.68.0/docs/resources/api_management_logger
...
export class ApiManagementLogger extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagementLogger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.68.0/docs/resources/api_management_logger#import import section} in the documentation of this resource for the id to use
