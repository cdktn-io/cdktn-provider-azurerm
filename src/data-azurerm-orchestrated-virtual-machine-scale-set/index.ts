...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/orchestrated_virtual_machine_scale_set
...
export interface DataAzurermOrchestratedVirtualMachineScaleSetConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/orchestrated_virtual_machine_scale_set#id DataAzurermOrchestratedVirtualMachineScaleSet#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/orchestrated_virtual_machine_scale_set#name DataAzurermOrchestratedVirtualMachineScaleSet#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/orchestrated_virtual_machine_scale_set#resource_group_name DataAzurermOrchestratedVirtualMachineScaleSet#resource_group_name}
  */
  readonly resourceGroupName: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/orchestrated_virtual_machine_scale_set#timeouts DataAzurermOrchestratedVirtualMachineScaleSet#timeouts}
  */
...
export class DataAzurermOrchestratedVirtualMachineScaleSetIdentityOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermOrchestratedVirtualMachineScaleSetIdentityList extends cdktn.ComplexList {
...
export class DataAzurermOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressIpTagOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressIpTagList extends cdktn.ComplexList {
...
export class DataAzurermOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressList extends cdktn.ComplexList {
...
export class DataAzurermOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationList extends cdktn.ComplexList {
...
export class DataAzurermOrchestratedVirtualMachineScaleSetNetworkInterfaceOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermOrchestratedVirtualMachineScaleSetNetworkInterfaceList extends cdktn.ComplexList {
...
export interface DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSize {
}

export function dataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSizeToTerraform(struct?: DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSize): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSizeToHclTerraform(struct?: DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSize): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSizeOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSize | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSize | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSizeList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSizeOutputReference {
    return new DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSizeOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataAzurermOrchestratedVirtualMachineScaleSetSkuProfile {
}

export function dataAzurermOrchestratedVirtualMachineScaleSetSkuProfileToTerraform(struct?: DataAzurermOrchestratedVirtualMachineScaleSetSkuProfile): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAzurermOrchestratedVirtualMachineScaleSetSkuProfileToHclTerraform(struct?: DataAzurermOrchestratedVirtualMachineScaleSetSkuProfile): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermOrchestratedVirtualMachineScaleSetSkuProfile | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermOrchestratedVirtualMachineScaleSetSkuProfile | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // virtual_machine_size - computed: true, optional: false, required: false
  private _virtualMachineSize = new DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileVirtualMachineSizeList(this, "virtual_machine_size", true);
  public get virtualMachineSize() {
    return this._virtualMachineSize;
  }
}

export class DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileOutputReference {
    return new DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataAzurermOrchestratedVirtualMachineScaleSetTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/orchestrated_virtual_machine_scale_set#read DataAzurermOrchestratedVirtualMachineScaleSet#read}
  */
  readonly read?: string;
}

export function dataAzurermOrchestratedVirtualMachineScaleSetTimeoutsToTerraform(struct?: DataAzurermOrchestratedVirtualMachineScaleSetTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAzurermOrchestratedVirtualMachineScaleSetTimeoutsToHclTerraform(struct?: DataAzurermOrchestratedVirtualMachineScaleSetTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermOrchestratedVirtualMachineScaleSetTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermOrchestratedVirtualMachineScaleSetTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermOrchestratedVirtualMachineScaleSetTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/orchestrated_virtual_machine_scale_set azurerm_orchestrated_virtual_machine_scale_set}
*/
export class DataAzurermOrchestratedVirtualMachineScaleSet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOrchestratedVirtualMachineScaleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/orchestrated_virtual_machine_scale_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_orchestrated_virtual_machine_scale_set", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/data-sources/orchestrated_virtual_machine_scale_set azurerm_orchestrated_virtual_machine_scale_set} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // sku_profile - computed: true, optional: false, required: false
  private _skuProfile = new DataAzurermOrchestratedVirtualMachineScaleSetSkuProfileList(this, "sku_profile", false);
  public get skuProfile() {
