...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/lb_nat_pool
...
export class LbNatPool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LbNatPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/lb_nat_pool#import import section} in the documentation of this resource for the id to use
