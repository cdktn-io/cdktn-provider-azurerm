...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/data-sources/app_service_environment_v3
...
export interface DataAzurermAppServiceEnvironmentV3Config extends cdktn.TerraformMetaArguments {
  /**
...
export class DataAzurermAppServiceEnvironmentV3ClusterSettingOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermAppServiceEnvironmentV3ClusterSettingList extends cdktn.ComplexList {
...
export class DataAzurermAppServiceEnvironmentV3InboundNetworkDependenciesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermAppServiceEnvironmentV3InboundNetworkDependenciesList extends cdktn.ComplexList {
...
export function dataAzurermAppServiceEnvironmentV3TimeoutsToTerraform(struct?: DataAzurermAppServiceEnvironmentV3Timeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAzurermAppServiceEnvironmentV3TimeoutsToHclTerraform(struct?: DataAzurermAppServiceEnvironmentV3Timeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermAppServiceEnvironmentV3TimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermAppServiceEnvironmentV3Timeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermAppServiceEnvironmentV3Timeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataAzurermAppServiceEnvironmentV3 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermAppServiceEnvironmentV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/data-sources/app_service_environment_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/data-sources/app_service_environment_v3 azurerm_app_service_environment_v3} Data Source
  *
  * @param scope The scope in which to define this construct
