...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/eventhub
...
export interface EventhubCaptureDescriptionDestination {
  ...
  */
  readonly storageAuthenticationId?: string;
  /**
...
export function eventhubCaptureDescriptionDestinationToTerraform(struct?: EventhubCaptureDescriptionDestinationOutputReference | EventhubCaptureDescriptionDestination): any {
  ...
  return {
    ...
    storage_authentication_id: cdktn.stringToTerraform(struct!.storageAuthenticationId),
    storage_authentication_type: cdktn.stringToTerraform(struct!.storageAuthenticationType),
  }
}
...
export function eventhubCaptureDescriptionDestinationToHclTerraform(struct?: EventhubCaptureDescriptionDestinationOutputReference | EventhubCaptureDescriptionDestination): any {
  ...
  const attrs = {
    ...
    storage_authentication_id: {
      value: cdktn.stringToHclTerraform(struct!.storageAuthenticationId),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    storage_authentication_type: {
      value: cdktn.stringToHclTerraform(struct!.storageAuthenticationType),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class EventhubCaptureDescriptionDestinationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EventhubCaptureDescriptionDestination | undefined {
    ...
    if (this._storageAuthenticationId !== undefined) {
      hasAnyValues = true;
      internalValueResult.storageAuthenticationId = this._storageAuthenticationId;
    }
    if (this._storageAuthenticationType !== undefined) {
      hasAnyValues = true;
      internalValueResult.storageAuthenticationType = this._storageAuthenticationType;
    }
  ...
  public set internalValue(value: EventhubCaptureDescriptionDestination | undefined) {
    if (value === undefined) {
      ...
      this._storageAuthenticationId = undefined;
      ...
      this._storageAuthenticationId = value.storageAuthenticationId;
      this._storageAuthenticationType = value.storageAuthenticationType;
    }
  }
  ...
  // storage_authentication_id - computed: false, optional: true, required: false
  private _storageAuthenticationId?: string; 
  public get storageAuthenticationId() {
    return this.getStringAttribute('storage_authentication_id');
  }
  public set storageAuthenticationId(value: string) {
    this._storageAuthenticationId = value;
  }
  public resetStorageAuthenticationId() {
    this._storageAuthenticationId = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get storageAuthenticationIdInput() {
    return this._storageAuthenticationId;
  }

  // storage_authentication_type - computed: false, optional: true, required: false
...
export class Eventhub extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Eventhub that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/eventhub#import import section} in the documentation of this resource for the id to use
