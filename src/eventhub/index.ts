...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.66.0/docs/resources/eventhub
...
export class Eventhub extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Eventhub that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.66.0/docs/resources/eventhub#import import section} in the documentation of this resource for the id to use
