...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.76.0/docs/resources/digital_twins_endpoint_eventhub
...
export class DigitalTwinsEndpointEventhub extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DigitalTwinsEndpointEventhub that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.76.0/docs/resources/digital_twins_endpoint_eventhub#import import section} in the documentation of this resource for the id to use
