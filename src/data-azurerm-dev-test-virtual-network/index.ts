...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/dev_test_virtual_network
...
export class DataAzurermDevTestVirtualNetwork extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermDevTestVirtualNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/dev_test_virtual_network#import import section} in the documentation of this resource for the id to use
