...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/network_security_perimeter_association
...
export class NetworkSecurityPerimeterAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkSecurityPerimeterAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/network_security_perimeter_association#import import section} in the documentation of this resource for the id to use
