...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/policy_definition
...
export class PolicyDefinition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/policy_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/policy_definition azurerm_policy_definition} Resource
  *
  * @param scope The scope in which to define this construct
