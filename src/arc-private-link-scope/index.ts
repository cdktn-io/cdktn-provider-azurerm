...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/arc_private_link_scope
...
export class ArcPrivateLinkScope extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ArcPrivateLinkScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/arc_private_link_scope#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/arc_private_link_scope azurerm_arc_private_link_scope} Resource
  *
  * @param scope The scope in which to define this construct
