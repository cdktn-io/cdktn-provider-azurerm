...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/automation_runbook
...
export class AutomationRunbook extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomationRunbook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/automation_runbook#import import section} in the documentation of this resource for the id to use
