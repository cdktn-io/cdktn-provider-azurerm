...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/signalr_service
...
export class DataAzurermSignalrService extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermSignalrService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/signalr_service#import import section} in the documentation of this resource for the id to use
