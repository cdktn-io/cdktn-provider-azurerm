...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/data-sources/palo_alto_local_rulestack
...
export class DataAzurermPaloAltoLocalRulestack extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermPaloAltoLocalRulestack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/data-sources/palo_alto_local_rulestack#import import section} in the documentation of this resource for the id to use
