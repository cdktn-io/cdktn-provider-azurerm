...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/resources/eventgrid_partner_namespace
...
export class EventgridPartnerNamespace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventgridPartnerNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/resources/eventgrid_partner_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/resources/eventgrid_partner_namespace azurerm_eventgrid_partner_namespace} Resource
  *
  * @param scope The scope in which to define this construct
