...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/spring_cloud_active_deployment
...
export class SpringCloudActiveDeployment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SpringCloudActiveDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/resources/spring_cloud_active_deployment#import import section} in the documentation of this resource for the id to use
