...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/resources/virtual_machine_packet_capture
...
export interface VirtualMachinePacketCaptureConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly filter?: VirtualMachinePacketCaptureFilter[] | cdktn.IResolvable;
  /**
...
export function virtualMachinePacketCaptureFilterToTerraform(struct?: VirtualMachinePacketCaptureFilter | cdktn.IResolvable): any {
...
export function virtualMachinePacketCaptureFilterToHclTerraform(struct?: VirtualMachinePacketCaptureFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class VirtualMachinePacketCaptureFilterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): VirtualMachinePacketCaptureFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: VirtualMachinePacketCaptureFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class VirtualMachinePacketCaptureFilterList extends cdktn.ComplexList {
  public internalValue? : VirtualMachinePacketCaptureFilter[] | cdktn.IResolvable
...
export class VirtualMachinePacketCaptureStorageLocationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function virtualMachinePacketCaptureTimeoutsToTerraform(struct?: VirtualMachinePacketCaptureTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function virtualMachinePacketCaptureTimeoutsToHclTerraform(struct?: VirtualMachinePacketCaptureTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class VirtualMachinePacketCaptureTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): VirtualMachinePacketCaptureTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: VirtualMachinePacketCaptureTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
*/
export class VirtualMachinePacketCapture extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualMachinePacketCapture that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/resources/virtual_machine_packet_capture#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_virtual_machine_packet_capture", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/resources/virtual_machine_packet_capture azurerm_virtual_machine_packet_capture} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putFilter(value: VirtualMachinePacketCaptureFilter[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktn.listMapper(virtualMachinePacketCaptureFilterToTerraform, true)(this._filter.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktn.listMapperHcl(virtualMachinePacketCaptureFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "list",
