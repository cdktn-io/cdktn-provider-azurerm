...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/resources/fabric_capacity
...
export class FabricCapacity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricCapacity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/resources/fabric_capacity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/resources/fabric_capacity azurerm_fabric_capacity} Resource
  *
  * @param scope The scope in which to define this construct
