...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/fabric_capacity
...
export interface FabricCapacityConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class FabricCapacitySkuOutputReference extends cdktn.ComplexObject {
...
export function fabricCapacityTimeoutsToTerraform(struct?: FabricCapacityTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function fabricCapacityTimeoutsToHclTerraform(struct?: FabricCapacityTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class FabricCapacityTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): FabricCapacityTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: FabricCapacityTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class FabricCapacity extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricCapacity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/fabric_capacity#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FabricCapacity to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_fabric_capacity", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/fabric_capacity azurerm_fabric_capacity} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public get administrationMembers() {
    return cdktn.Fn.tolist(this.getListAttribute('administration_members'));
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      administration_members: cdktn.listMapper(cdktn.stringToTerraform, false)(this._administrationMembers),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      administration_members: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._administrationMembers),
        isBlock: false,
        type: "set",
