...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/security_center_setting
...
export class SecurityCenterSetting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityCenterSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/security_center_setting#import import section} in the documentation of this resource for the id to use
