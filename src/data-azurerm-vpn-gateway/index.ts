...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.68.0/docs/data-sources/vpn_gateway
...
export class DataAzurermVpnGateway extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermVpnGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.68.0/docs/data-sources/vpn_gateway#import import section} in the documentation of this resource for the id to use
