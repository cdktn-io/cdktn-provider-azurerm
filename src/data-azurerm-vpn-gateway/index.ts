...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/vpn_gateway
...
export interface DataAzurermVpnGatewayConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermVpnGatewayBgpSettingsInstance0BgpPeeringAddressList extends cdktn.ComplexList {
...
export class DataAzurermVpnGatewayBgpSettingsInstance1BgpPeeringAddressOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVpnGatewayBgpSettingsInstance1BgpPeeringAddressList extends cdktn.ComplexList {
...
export class DataAzurermVpnGatewayBgpSettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVpnGatewayBgpSettingsList extends cdktn.ComplexList {
...
export class DataAzurermVpnGatewayIpConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVpnGatewayIpConfigurationList extends cdktn.ComplexList {
...
export function dataAzurermVpnGatewayTimeoutsToTerraform(struct?: DataAzurermVpnGatewayTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAzurermVpnGatewayTimeoutsToHclTerraform(struct?: DataAzurermVpnGatewayTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurermVpnGatewayTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermVpnGatewayTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermVpnGatewayTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataAzurermVpnGateway extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermVpnGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/vpn_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/vpn_gateway azurerm_vpn_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
