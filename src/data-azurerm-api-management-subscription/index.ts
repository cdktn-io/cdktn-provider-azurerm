...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/data-sources/api_management_subscription
...
export class DataAzurermApiManagementSubscription extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermApiManagementSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/data-sources/api_management_subscription#import import section} in the documentation of this resource for the id to use
