...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/trusted_signing_account
...
export class TrustedSigningAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TrustedSigningAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/trusted_signing_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/resources/trusted_signing_account azurerm_trusted_signing_account} Resource
  *
  * @param scope The scope in which to define this construct
