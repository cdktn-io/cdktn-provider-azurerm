...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/private_dns_ptr_record
...
export class PrivateDnsPtrRecord extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateDnsPtrRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/private_dns_ptr_record#import import section} in the documentation of this resource for the id to use
