...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/healthcare_medtech_service_fhir_destination
...
export class HealthcareMedtechServiceFhirDestination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthcareMedtechServiceFhirDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/healthcare_medtech_service_fhir_destination#import import section} in the documentation of this resource for the id to use
