...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/route_table
...
export class RouteTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RouteTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/route_table#import import section} in the documentation of this resource for the id to use
