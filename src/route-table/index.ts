...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/route_table
...
export function routeTableRouteToTerraform(struct?: RouteTableRoute | cdktn.IResolvable): any {
  ...
  return {
    address_prefix: struct!.addressPrefix === undefined ? null : cdktn.stringToTerraform(struct!.addressPrefix),
    name: struct!.name === undefined ? null : cdktn.stringToTerraform(struct!.name),
    next_hop_in_ip_address: struct!.nextHopInIpAddress === undefined ? null : cdktn.stringToTerraform(struct!.nextHopInIpAddress),
    next_hop_type: struct!.nextHopType === undefined ? null : cdktn.stringToTerraform(struct!.nextHopType),
  }
}
...
export function routeTableRouteToHclTerraform(struct?: RouteTableRoute | cdktn.IResolvable): any {
  ...
  const attrs = {
    address_prefix: {
      value: struct!.addressPrefix === undefined ? null : cdktn.stringToHclTerraform(struct!.addressPrefix),
      isBlock: false,
      type: "simple",
    ...
    next_hop_in_ip_address: {
      value: struct!.nextHopInIpAddress === undefined ? null : cdktn.stringToHclTerraform(struct!.nextHopInIpAddress),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    next_hop_type: {
      value: struct!.nextHopType === undefined ? null : cdktn.stringToHclTerraform(struct!.nextHopType),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class RouteTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RouteTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/route_table#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RouteTable to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_route_table", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/route_table azurerm_route_table} Resource
  *
  * @param scope The scope in which to define this construct
