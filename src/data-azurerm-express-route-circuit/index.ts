...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.67.0/docs/data-sources/express_route_circuit
...
export class DataAzurermExpressRouteCircuit extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermExpressRouteCircuit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.67.0/docs/data-sources/express_route_circuit#import import section} in the documentation of this resource for the id to use
