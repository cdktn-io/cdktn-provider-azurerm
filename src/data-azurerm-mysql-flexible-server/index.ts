...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/data-sources/mysql_flexible_server
...
export interface DataAzurermMysqlFlexibleServerConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataAzurermMysqlFlexibleServerHighAvailabilityOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermMysqlFlexibleServerHighAvailabilityList extends cdktn.ComplexList {
...
export class DataAzurermMysqlFlexibleServerMaintenanceWindowOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermMysqlFlexibleServerMaintenanceWindowList extends cdktn.ComplexList {
...
export class DataAzurermMysqlFlexibleServerStorageOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermMysqlFlexibleServerStorageList extends cdktn.ComplexList {
...
export function dataAzurermMysqlFlexibleServerTimeoutsToTerraform(struct?: DataAzurermMysqlFlexibleServerTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAzurermMysqlFlexibleServerTimeoutsToHclTerraform(struct?: DataAzurermMysqlFlexibleServerTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurermMysqlFlexibleServerTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermMysqlFlexibleServerTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermMysqlFlexibleServerTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataAzurermMysqlFlexibleServer extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermMysqlFlexibleServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/data-sources/mysql_flexible_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/data-sources/mysql_flexible_server azurerm_mysql_flexible_server} Data Source
  *
  * @param scope The scope in which to define this construct
