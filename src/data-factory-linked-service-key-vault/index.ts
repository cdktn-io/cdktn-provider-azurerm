...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/data_factory_linked_service_key_vault
...
export interface DataFactoryLinkedServiceKeyVaultConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function dataFactoryLinkedServiceKeyVaultTimeoutsToTerraform(struct?: DataFactoryLinkedServiceKeyVaultTimeouts | cdktn.IResolvable): any {
...
export function dataFactoryLinkedServiceKeyVaultTimeoutsToHclTerraform(struct?: DataFactoryLinkedServiceKeyVaultTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataFactoryLinkedServiceKeyVaultTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataFactoryLinkedServiceKeyVaultTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataFactoryLinkedServiceKeyVaultTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataFactoryLinkedServiceKeyVault extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataFactoryLinkedServiceKeyVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/data_factory_linked_service_key_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_data_factory_linked_service_key_vault", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/data_factory_linked_service_key_vault azurerm_data_factory_linked_service_key_vault} Resource
  *
  * @param scope The scope in which to define this construct
