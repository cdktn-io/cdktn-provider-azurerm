...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/mysql_flexible_database
...
export class MysqlFlexibleDatabase extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlFlexibleDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/mysql_flexible_database#import import section} in the documentation of this resource for the id to use
