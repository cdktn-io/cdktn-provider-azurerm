...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app
...
export interface BotWebAppConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#developer_app_insights_api_key BotWebApp#developer_app_insights_api_key}
  */
  readonly developerAppInsightsApiKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#developer_app_insights_application_id BotWebApp#developer_app_insights_application_id}
  */
  readonly developerAppInsightsApplicationId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#developer_app_insights_key BotWebApp#developer_app_insights_key}
  */
  readonly developerAppInsightsKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#display_name BotWebApp#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#endpoint BotWebApp#endpoint}
  */
  readonly endpoint?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#id BotWebApp#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#location BotWebApp#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#luis_app_ids BotWebApp#luis_app_ids}
  */
  readonly luisAppIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#luis_key BotWebApp#luis_key}
  */
  readonly luisKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#microsoft_app_id BotWebApp#microsoft_app_id}
  */
  readonly microsoftAppId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#microsoft_app_tenant_id BotWebApp#microsoft_app_tenant_id}
  */
  readonly microsoftAppTenantId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#microsoft_app_type BotWebApp#microsoft_app_type}
  */
  readonly microsoftAppType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#microsoft_app_user_assigned_identity_id BotWebApp#microsoft_app_user_assigned_identity_id}
  */
  readonly microsoftAppUserAssignedIdentityId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#name BotWebApp#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#resource_group_name BotWebApp#resource_group_name}
  */
  readonly resourceGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#sku BotWebApp#sku}
  */
  readonly sku: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#tags BotWebApp#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#timeouts BotWebApp#timeouts}
  */
  readonly timeouts?: BotWebAppTimeouts;
}
export interface BotWebAppTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#create BotWebApp#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#delete BotWebApp#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#read BotWebApp#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#update BotWebApp#update}
  */
  readonly update?: string;
}

export function botWebAppTimeoutsToTerraform(struct?: BotWebAppTimeouts | cdktn.IResolvable): any {
...
export function botWebAppTimeoutsToHclTerraform(struct?: BotWebAppTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class BotWebAppTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BotWebAppTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: BotWebAppTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app azurerm_bot_web_app}
*/
export class BotWebApp extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BotWebApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the BotWebApp to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_bot_web_app", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/bot_web_app azurerm_bot_web_app} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: BotWebAppConfig) {
    ...
    this._microsoftAppUserAssignedIdentityId = config.microsoftAppUserAssignedIdentityId;
  ...
  // microsoft_app_type - computed: true, optional: true, required: false
  ...
  // microsoft_app_user_assigned_identity_id - computed: false, optional: true, required: false
  private _microsoftAppUserAssignedIdentityId?: string; 
  public get microsoftAppUserAssignedIdentityId() {
    return this.getStringAttribute('microsoft_app_user_assigned_identity_id');
  }
  public set microsoftAppUserAssignedIdentityId(value: string) {
    this._microsoftAppUserAssignedIdentityId = value;
  }
  public resetMicrosoftAppUserAssignedIdentityId() {
    this._microsoftAppUserAssignedIdentityId = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get microsoftAppUserAssignedIdentityIdInput() {
    return this._microsoftAppUserAssignedIdentityId;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      microsoft_app_user_assigned_identity_id: cdktn.stringToTerraform(this._microsoftAppUserAssignedIdentityId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      microsoft_app_user_assigned_identity_id: {
        value: cdktn.stringToHclTerraform(this._microsoftAppUserAssignedIdentityId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
