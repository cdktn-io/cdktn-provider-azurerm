...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/restore_point_collection
...
export class RestorePointCollection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RestorePointCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/restore_point_collection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/restore_point_collection azurerm_restore_point_collection} Resource
  *
  * @param scope The scope in which to define this construct
