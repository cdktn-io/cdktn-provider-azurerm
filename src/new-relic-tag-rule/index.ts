...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.1/docs/resources/new_relic_tag_rule
...
export class NewRelicTagRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NewRelicTagRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.1/docs/resources/new_relic_tag_rule#import import section} in the documentation of this resource for the id to use
