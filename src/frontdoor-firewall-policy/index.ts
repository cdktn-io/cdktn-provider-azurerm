...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/frontdoor_firewall_policy
...
export class FrontdoorFirewallPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FrontdoorFirewallPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/frontdoor_firewall_policy#import import section} in the documentation of this resource for the id to use
