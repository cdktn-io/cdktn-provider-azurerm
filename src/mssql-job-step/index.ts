...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/mssql_job_step
...
export class MssqlJobStep extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MssqlJobStep that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/mssql_job_step#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.6.0/docs/resources/mssql_job_step azurerm_mssql_job_step} Resource
  *
  * @param scope The scope in which to define this construct
