...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/blueprint_published_version
...
export interface DataAzurermBlueprintPublishedVersionConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function dataAzurermBlueprintPublishedVersionTimeoutsToTerraform(struct?: DataAzurermBlueprintPublishedVersionTimeouts | cdktn.IResolvable): any {
...
export function dataAzurermBlueprintPublishedVersionTimeoutsToHclTerraform(struct?: DataAzurermBlueprintPublishedVersionTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermBlueprintPublishedVersionTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermBlueprintPublishedVersionTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermBlueprintPublishedVersionTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataAzurermBlueprintPublishedVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermBlueprintPublishedVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/blueprint_published_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_blueprint_published_version", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/blueprint_published_version azurerm_blueprint_published_version} Data Source
  *
  * @param scope The scope in which to define this construct
