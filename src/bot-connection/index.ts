...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/bot_connection
...
export class BotConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BotConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/bot_connection#import import section} in the documentation of this resource for the id to use
