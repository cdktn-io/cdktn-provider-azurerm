...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.68.0/docs/resources/eventgrid_event_subscription
...
export class EventgridEventSubscription extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventgridEventSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.68.0/docs/resources/eventgrid_event_subscription#import import section} in the documentation of this resource for the id to use
