...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/resources/storage_account_network_rules
...
export class StorageAccountNetworkRulesA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageAccountNetworkRulesA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/resources/storage_account_network_rules#import import section} in the documentation of this resource for the id to use
