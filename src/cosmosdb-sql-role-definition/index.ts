...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.1/docs/resources/cosmosdb_sql_role_definition
...
export class CosmosdbSqlRoleDefinition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CosmosdbSqlRoleDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.1/docs/resources/cosmosdb_sql_role_definition#import import section} in the documentation of this resource for the id to use
