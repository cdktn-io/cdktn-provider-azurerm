...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration
...
export interface AppConfigurationConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#data_plane_proxy_authentication_mode AppConfiguration#data_plane_proxy_authentication_mode}
  */
  readonly dataPlaneProxyAuthenticationMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#data_plane_proxy_private_link_delegation_enabled AppConfiguration#data_plane_proxy_private_link_delegation_enabled}
  */
  readonly dataPlaneProxyPrivateLinkDelegationEnabled?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#id AppConfiguration#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#local_auth_enabled AppConfiguration#local_auth_enabled}
  */
  readonly localAuthEnabled?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#location AppConfiguration#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#name AppConfiguration#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#public_network_access AppConfiguration#public_network_access}
  */
  readonly publicNetworkAccess?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#purge_protection_enabled AppConfiguration#purge_protection_enabled}
  */
  readonly purgeProtectionEnabled?: boolean | cdktn.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#resource_group_name AppConfiguration#resource_group_name}
  */
  readonly resourceGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#sku AppConfiguration#sku}
  */
  readonly sku?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#soft_delete_retention_days AppConfiguration#soft_delete_retention_days}
  */
  readonly softDeleteRetentionDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#tags AppConfiguration#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * encryption block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#encryption AppConfiguration#encryption}
  */
  readonly encryption?: AppConfigurationEncryption;
  /**
  * identity block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#identity AppConfiguration#identity}
  */
  readonly identity?: AppConfigurationIdentity;
  /**
  * replica block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#replica AppConfiguration#replica}
  */
  readonly replica?: AppConfigurationReplica[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#timeouts AppConfiguration#timeouts}
  */
...
export class AppConfigurationPrimaryReadKeyOutputReference extends cdktn.ComplexObject {
...
export class AppConfigurationPrimaryReadKeyList extends cdktn.ComplexList {
...
export class AppConfigurationPrimaryWriteKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class AppConfigurationPrimaryWriteKeyList extends cdktn.ComplexList {
...
export class AppConfigurationSecondaryReadKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class AppConfigurationSecondaryReadKeyList extends cdktn.ComplexList {
...
export class AppConfigurationSecondaryWriteKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class AppConfigurationSecondaryWriteKeyList extends cdktn.ComplexList {
...
export interface AppConfigurationEncryption {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#identity_client_id AppConfiguration#identity_client_id}
  */
  readonly identityClientId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#key_vault_key_identifier AppConfiguration#key_vault_key_identifier}
  */
...
export function appConfigurationEncryptionToTerraform(struct?: AppConfigurationEncryptionOutputReference | AppConfigurationEncryption): any {
  ...
  return {
    ...
    key_vault_key_identifier: cdktn.stringToTerraform(struct!.keyVaultKeyIdentifier),
  }
}
...
export function appConfigurationEncryptionToHclTerraform(struct?: AppConfigurationEncryptionOutputReference | AppConfigurationEncryption): any {
  ...
  const attrs = {
    ...
    key_vault_key_identifier: {
      value: cdktn.stringToHclTerraform(struct!.keyVaultKeyIdentifier),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class AppConfigurationEncryptionOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface AppConfigurationIdentity {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#identity_ids AppConfiguration#identity_ids}
  */
  readonly identityIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#type AppConfiguration#type}
  */
...
export class AppConfigurationIdentityOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function appConfigurationReplicaToTerraform(struct?: AppConfigurationReplica | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function appConfigurationReplicaToHclTerraform(struct?: AppConfigurationReplica | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class AppConfigurationReplicaOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): AppConfigurationReplica | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: AppConfigurationReplica | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class AppConfigurationReplicaList extends cdktn.ComplexList {
  public internalValue? : AppConfigurationReplica[] | cdktn.IResolvable
...
export interface AppConfigurationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#create AppConfiguration#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#delete AppConfiguration#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#read AppConfiguration#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#update AppConfiguration#update}
  */
  readonly update?: string;
}

export function appConfigurationTimeoutsToTerraform(struct?: AppConfigurationTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function appConfigurationTimeoutsToHclTerraform(struct?: AppConfigurationTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class AppConfigurationTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): AppConfigurationTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: AppConfigurationTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration azurerm_app_configuration}
*/
export class AppConfiguration extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a AppConfiguration resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AppConfiguration to import
  * @param importFromId The id of the existing AppConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AppConfiguration to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_app_configuration", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/resources/app_configuration azurerm_app_configuration} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _dataPlaneProxyPrivateLinkDelegationEnabled?: boolean | cdktn.IResolvable; 
  ...
  public set dataPlaneProxyPrivateLinkDelegationEnabled(value: boolean | cdktn.IResolvable) {
  ...
  public putReplica(value: AppConfigurationReplica[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      data_plane_proxy_authentication_mode: cdktn.stringToTerraform(this._dataPlaneProxyAuthenticationMode),
      data_plane_proxy_private_link_delegation_enabled: cdktn.booleanToTerraform(this._dataPlaneProxyPrivateLinkDelegationEnabled),
      ...
      replica: cdktn.listMapper(appConfigurationReplicaToTerraform, true)(this._replica.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      data_plane_proxy_authentication_mode: {
        value: cdktn.stringToHclTerraform(this._dataPlaneProxyAuthenticationMode),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      data_plane_proxy_private_link_delegation_enabled: {
        value: cdktn.booleanToHclTerraform(this._dataPlaneProxyPrivateLinkDelegationEnabled),
        isBlock: false,
        type: "simple",
      ...
      replica: {
        value: cdktn.listMapperHcl(appConfigurationReplicaToHclTerraform, true)(this._replica.internalValue),
        isBlock: true,
        type: "set",
