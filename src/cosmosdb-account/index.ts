...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/cosmosdb_account
...
export class CosmosdbAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CosmosdbAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/cosmosdb_account#import import section} in the documentation of this resource for the id to use
