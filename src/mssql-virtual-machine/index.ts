...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.68.0/docs/resources/mssql_virtual_machine
...
export class MssqlVirtualMachine extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MssqlVirtualMachine that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.68.0/docs/resources/mssql_virtual_machine#import import section} in the documentation of this resource for the id to use
