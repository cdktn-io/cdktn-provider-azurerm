...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/service_plan
...
export interface ServicePlanConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly perSiteScalingEnabled?: boolean | cdktn.IResolvable;
  /**
  ...
  */
  readonly premiumPlanAutoScaleEnabled?: boolean | cdktn.IResolvable;
  /**
  ...
  */
  readonly zoneBalancingEnabled?: boolean | cdktn.IResolvable;
  /**
  * timeouts block
  *
...
export function servicePlanTimeoutsToTerraform(struct?: ServicePlanTimeouts | cdktn.IResolvable): any {
...
export function servicePlanTimeoutsToHclTerraform(struct?: ServicePlanTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ServicePlanTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServicePlanTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ServicePlanTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ServicePlan extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicePlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/service_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/service_plan azurerm_service_plan} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _perSiteScalingEnabled?: boolean | cdktn.IResolvable; 
  public get perSiteScalingEnabled() {
    return this.getBooleanAttribute('per_site_scaling_enabled');
  }
  public set perSiteScalingEnabled(value: boolean | cdktn.IResolvable) {
  ...
  private _premiumPlanAutoScaleEnabled?: boolean | cdktn.IResolvable; 
  public get premiumPlanAutoScaleEnabled() {
    return this.getBooleanAttribute('premium_plan_auto_scale_enabled');
  }
  public set premiumPlanAutoScaleEnabled(value: boolean | cdktn.IResolvable) {
  ...
  private _zoneBalancingEnabled?: boolean | cdktn.IResolvable; 
  public get zoneBalancingEnabled() {
    return this.getBooleanAttribute('zone_balancing_enabled');
  }
  public set zoneBalancingEnabled(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      per_site_scaling_enabled: cdktn.booleanToTerraform(this._perSiteScalingEnabled),
      premium_plan_auto_scale_enabled: cdktn.booleanToTerraform(this._premiumPlanAutoScaleEnabled),
      resource_group_name: cdktn.stringToTerraform(this._resourceGroupName),
      sku_name: cdktn.stringToTerraform(this._skuName),
      tags: cdktn.hashMapper(cdktn.stringToTerraform)(this._tags),
      worker_count: cdktn.numberToTerraform(this._workerCount),
      zone_balancing_enabled: cdktn.booleanToTerraform(this._zoneBalancingEnabled),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      per_site_scaling_enabled: {
        value: cdktn.booleanToHclTerraform(this._perSiteScalingEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      premium_plan_auto_scale_enabled: {
        value: cdktn.booleanToHclTerraform(this._premiumPlanAutoScaleEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      worker_count: {
        value: cdktn.numberToHclTerraform(this._workerCount),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      zone_balancing_enabled: {
        value: cdktn.booleanToHclTerraform(this._zoneBalancingEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
