...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/resources/container_registry
...
export class ContainerRegistry extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/resources/container_registry#import import section} in the documentation of this resource for the id to use
