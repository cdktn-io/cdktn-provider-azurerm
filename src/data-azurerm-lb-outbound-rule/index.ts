...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.5.0/docs/data-sources/lb_outbound_rule
...
export class DataAzurermLbOutboundRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermLbOutboundRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.5.0/docs/data-sources/lb_outbound_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.5.0/docs/data-sources/lb_outbound_rule azurerm_lb_outbound_rule} Data Source
  *
  * @param scope The scope in which to define this construct
