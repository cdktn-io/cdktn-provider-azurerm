...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/mssql_elasticpool
...
export class MssqlElasticpool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MssqlElasticpool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/mssql_elasticpool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/mssql_elasticpool azurerm_mssql_elasticpool} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: MssqlElasticpoolConfig) {
    ...
    this._highAvailabilityReplicaCount = config.highAvailabilityReplicaCount;
    this._id = config.id;
  ...
  // high_availability_replica_count - computed: true, optional: true, required: false
  private _highAvailabilityReplicaCount?: number; 
  public get highAvailabilityReplicaCount() {
    return this.getNumberAttribute('high_availability_replica_count');
  }
  public set highAvailabilityReplicaCount(value: number) {
    this._highAvailabilityReplicaCount = value;
  }
  public resetHighAvailabilityReplicaCount() {
    this._highAvailabilityReplicaCount = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get highAvailabilityReplicaCountInput() {
    return this._highAvailabilityReplicaCount;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      high_availability_replica_count: cdktn.numberToTerraform(this._highAvailabilityReplicaCount),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      high_availability_replica_count: {
        value: cdktn.numberToHclTerraform(this._highAvailabilityReplicaCount),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
