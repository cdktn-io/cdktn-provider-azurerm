...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/resources/mssql_elasticpool
...
export class MssqlElasticpool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MssqlElasticpool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/resources/mssql_elasticpool#import import section} in the documentation of this resource for the id to use
