...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/stack_hci_deployment_setting
...
export class StackHciDeploymentSetting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StackHciDeploymentSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/stack_hci_deployment_setting#import import section} in the documentation of this resource for the id to use
