...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/stack_hci_extension
...
export class StackHciExtension extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StackHciExtension that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/stack_hci_extension#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/stack_hci_extension azurerm_stack_hci_extension} Resource
  *
  * @param scope The scope in which to define this construct
