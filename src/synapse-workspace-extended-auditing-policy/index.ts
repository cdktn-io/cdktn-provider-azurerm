...
export function synapseWorkspaceExtendedAuditingPolicyTimeoutsToTerraform(struct?: SynapseWorkspaceExtendedAuditingPolicyTimeouts | cdktf.IResolvable): any {
...
export function synapseWorkspaceExtendedAuditingPolicyTimeoutsToHclTerraform(struct?: SynapseWorkspaceExtendedAuditingPolicyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SynapseWorkspaceExtendedAuditingPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SynapseWorkspaceExtendedAuditingPolicyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SynapseWorkspaceExtendedAuditingPolicyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SynapseWorkspaceExtendedAuditingPolicy extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_synapse_workspace_extended_auditing_policy", importId: importFromId, provider });
      }
