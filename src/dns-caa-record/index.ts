...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/dns_caa_record
...
export class DnsCaaRecord extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsCaaRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/dns_caa_record#import import section} in the documentation of this resource for the id to use
