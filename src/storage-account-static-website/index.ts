...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.1/docs/resources/storage_account_static_website
...
export class StorageAccountStaticWebsiteA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageAccountStaticWebsiteA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.1/docs/resources/storage_account_static_website#import import section} in the documentation of this resource for the id to use
