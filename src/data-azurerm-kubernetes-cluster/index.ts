...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/kubernetes_cluster
...
export class DataAzurermKubernetesCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermKubernetesCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/kubernetes_cluster#import import section} in the documentation of this resource for the id to use
