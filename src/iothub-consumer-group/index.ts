...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/iothub_consumer_group
...
export class IothubConsumerGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IothubConsumerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/iothub_consumer_group#import import section} in the documentation of this resource for the id to use
