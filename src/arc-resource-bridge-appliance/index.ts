...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/arc_resource_bridge_appliance
...
export class ArcResourceBridgeAppliance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ArcResourceBridgeAppliance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/arc_resource_bridge_appliance#import import section} in the documentation of this resource for the id to use
