...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.66.0/docs/resources/iothub_device_update_instance
...
export class IothubDeviceUpdateInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IothubDeviceUpdateInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.66.0/docs/resources/iothub_device_update_instance#import import section} in the documentation of this resource for the id to use
