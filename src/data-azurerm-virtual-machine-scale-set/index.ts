...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/data-sources/virtual_machine_scale_set
...
export interface DataAzurermVirtualMachineScaleSetConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataAzurermVirtualMachineScaleSetIdentityOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermVirtualMachineScaleSetIdentityList extends cdktn.ComplexList {
...
export class DataAzurermVirtualMachineScaleSetInstancesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVirtualMachineScaleSetInstancesList extends cdktn.ComplexList {
...
export class DataAzurermVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressIpTagOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressIpTagList extends cdktn.ComplexList {
...
export class DataAzurermVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressList extends cdktn.ComplexList {
...
export class DataAzurermVirtualMachineScaleSetNetworkInterfaceIpConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVirtualMachineScaleSetNetworkInterfaceIpConfigurationList extends cdktn.ComplexList {
...
export class DataAzurermVirtualMachineScaleSetNetworkInterfaceOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  // auxiliary_mode - computed: true, optional: false, required: false
  public get auxiliaryMode() {
    return this.getStringAttribute('auxiliary_mode');
  }

  // auxiliary_sku - computed: true, optional: false, required: false
...
export class DataAzurermVirtualMachineScaleSetNetworkInterfaceList extends cdktn.ComplexList {
...
export function dataAzurermVirtualMachineScaleSetTimeoutsToTerraform(struct?: DataAzurermVirtualMachineScaleSetTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAzurermVirtualMachineScaleSetTimeoutsToHclTerraform(struct?: DataAzurermVirtualMachineScaleSetTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermVirtualMachineScaleSetTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermVirtualMachineScaleSetTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermVirtualMachineScaleSetTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataAzurermVirtualMachineScaleSet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermVirtualMachineScaleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/data-sources/virtual_machine_scale_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/data-sources/virtual_machine_scale_set azurerm_virtual_machine_scale_set} Data Source
  *
  * @param scope The scope in which to define this construct
