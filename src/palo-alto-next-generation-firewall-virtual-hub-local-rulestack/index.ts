...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.74.0/docs/resources/palo_alto_next_generation_firewall_virtual_hub_local_rulestack
...
export class PaloAltoNextGenerationFirewallVirtualHubLocalRulestack extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PaloAltoNextGenerationFirewallVirtualHubLocalRulestack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.74.0/docs/resources/palo_alto_next_generation_firewall_virtual_hub_local_rulestack#import import section} in the documentation of this resource for the id to use
