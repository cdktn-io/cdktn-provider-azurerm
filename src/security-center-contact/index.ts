...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.1/docs/resources/security_center_contact
...
export class SecurityCenterContact extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityCenterContact that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.1/docs/resources/security_center_contact#import import section} in the documentation of this resource for the id to use
