...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/route_server_bgp_connection
...
export class RouteServerBgpConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RouteServerBgpConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/route_server_bgp_connection#import import section} in the documentation of this resource for the id to use
