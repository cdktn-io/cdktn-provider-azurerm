...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/extended_custom_location
...
export class ExtendedCustomLocation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ExtendedCustomLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/resources/extended_custom_location#import import section} in the documentation of this resource for the id to use
