...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/management_group_template_deployment
...
export class DataAzurermManagementGroupTemplateDeployment extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermManagementGroupTemplateDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/management_group_template_deployment#import import section} in the documentation of this resource for the id to use
