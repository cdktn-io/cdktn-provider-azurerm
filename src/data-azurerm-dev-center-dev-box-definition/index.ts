...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/dev_center_dev_box_definition
...
export class DataAzurermDevCenterDevBoxDefinition extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermDevCenterDevBoxDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/data-sources/dev_center_dev_box_definition#import import section} in the documentation of this resource for the id to use
