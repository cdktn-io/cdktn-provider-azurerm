...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/batch_job
...
export class BatchJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BatchJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/batch_job#import import section} in the documentation of this resource for the id to use
