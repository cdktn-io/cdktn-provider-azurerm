...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/iot_security_device_group
...
export class IotSecurityDeviceGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotSecurityDeviceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/iot_security_device_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/iot_security_device_group azurerm_iot_security_device_group} Resource
  *
  * @param scope The scope in which to define this construct
