...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/app_service_source_control
...
export class AppServiceSourceControl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppServiceSourceControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/resources/app_service_source_control#import import section} in the documentation of this resource for the id to use
