...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/oracle_autonomous_database_clone_from_backup
...
export interface DataAzurermOracleAutonomousDatabaseCloneFromBackupConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupScheduleOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupScheduleList extends cdktn.ComplexList {
...
export function dataAzurermOracleAutonomousDatabaseCloneFromBackupTimeoutsToTerraform(struct?: DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAzurermOracleAutonomousDatabaseCloneFromBackupTimeoutsToHclTerraform(struct?: DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataAzurermOracleAutonomousDatabaseCloneFromBackup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOracleAutonomousDatabaseCloneFromBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/oracle_autonomous_database_clone_from_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/oracle_autonomous_database_clone_from_backup azurerm_oracle_autonomous_database_clone_from_backup} Data Source
  *
  * @param scope The scope in which to define this construct
