...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.1/docs/data-sources/mssql_elasticpool
...
export class DataAzurermMssqlElasticpool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermMssqlElasticpool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.1/docs/data-sources/mssql_elasticpool#import import section} in the documentation of this resource for the id to use
