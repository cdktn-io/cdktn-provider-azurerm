...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/application_gateway
...
export class DataAzurermApplicationGateway extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermApplicationGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/application_gateway#import import section} in the documentation of this resource for the id to use
