...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/app_configuration
...
export interface DataAzurermAppConfigurationConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/app_configuration#id DataAzurermAppConfiguration#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/app_configuration#name DataAzurermAppConfiguration#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/app_configuration#resource_group_name DataAzurermAppConfiguration#resource_group_name}
  */
  readonly resourceGroupName: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/app_configuration#timeouts DataAzurermAppConfiguration#timeouts}
  */
...
export class DataAzurermAppConfigurationEncryptionOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermAppConfigurationEncryptionList extends cdktn.ComplexList {
...
export class DataAzurermAppConfigurationIdentityOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermAppConfigurationIdentityList extends cdktn.ComplexList {
...
export class DataAzurermAppConfigurationPrimaryReadKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermAppConfigurationPrimaryReadKeyList extends cdktn.ComplexList {
...
export class DataAzurermAppConfigurationPrimaryWriteKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermAppConfigurationPrimaryWriteKeyList extends cdktn.ComplexList {
...
export function dataAzurermAppConfigurationReplicaToTerraform(struct?: DataAzurermAppConfigurationReplica): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermAppConfigurationReplicaOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermAppConfigurationReplica | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermAppConfigurationReplica | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAzurermAppConfigurationReplicaList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAzurermAppConfigurationReplicaOutputReference {
    return new DataAzurermAppConfigurationReplicaOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAzurermAppConfigurationSecondaryReadKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermAppConfigurationSecondaryReadKeyList extends cdktn.ComplexList {
...
export class DataAzurermAppConfigurationSecondaryWriteKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermAppConfigurationSecondaryWriteKeyList extends cdktn.ComplexList {
...
export interface DataAzurermAppConfigurationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/app_configuration#read DataAzurermAppConfiguration#read}
  */
  readonly read?: string;
}

export function dataAzurermAppConfigurationTimeoutsToTerraform(struct?: DataAzurermAppConfigurationTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAzurermAppConfigurationTimeoutsToHclTerraform(struct?: DataAzurermAppConfigurationTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermAppConfigurationTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermAppConfigurationTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermAppConfigurationTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/app_configuration azurerm_app_configuration}
*/
export class DataAzurermAppConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermAppConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/app_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/app_configuration azurerm_app_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // data_plane_proxy_authentication_mode - computed: true, optional: false, required: false
  public get dataPlaneProxyAuthenticationMode() {
    return this.getStringAttribute('data_plane_proxy_authentication_mode');
  }

  // data_plane_proxy_private_link_delegation_enabled - computed: true, optional: false, required: false
  ...
  private _replica = new DataAzurermAppConfigurationReplicaList(this, "replica", false);
  public get replica() {
