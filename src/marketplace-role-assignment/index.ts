...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/marketplace_role_assignment
...
export interface MarketplaceRoleAssignmentConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function marketplaceRoleAssignmentTimeoutsToTerraform(struct?: MarketplaceRoleAssignmentTimeouts | cdktn.IResolvable): any {
...
export function marketplaceRoleAssignmentTimeoutsToHclTerraform(struct?: MarketplaceRoleAssignmentTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class MarketplaceRoleAssignmentTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MarketplaceRoleAssignmentTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: MarketplaceRoleAssignmentTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class MarketplaceRoleAssignment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MarketplaceRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/marketplace_role_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_marketplace_role_assignment", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/marketplace_role_assignment azurerm_marketplace_role_assignment} Resource
  *
  * @param scope The scope in which to define this construct
