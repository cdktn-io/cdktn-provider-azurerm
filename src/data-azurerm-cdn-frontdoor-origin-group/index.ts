...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/data-sources/cdn_frontdoor_origin_group
...
export class DataAzurermCdnFrontdoorOriginGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermCdnFrontdoorOriginGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.2.0/docs/data-sources/cdn_frontdoor_origin_group#import import section} in the documentation of this resource for the id to use
