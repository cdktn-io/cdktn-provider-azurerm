...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/cosmosdb_postgresql_cluster
...
export class CosmosdbPostgresqlCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CosmosdbPostgresqlCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/cosmosdb_postgresql_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/cosmosdb_postgresql_cluster azurerm_cosmosdb_postgresql_cluster} Resource
  *
  * @param scope The scope in which to define this construct
