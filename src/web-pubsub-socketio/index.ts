...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/web_pubsub_socketio
...
export class WebPubsubSocketio extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WebPubsubSocketio that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/web_pubsub_socketio#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.81.0/docs/resources/web_pubsub_socketio azurerm_web_pubsub_socketio} Resource
  *
  * @param scope The scope in which to define this construct
