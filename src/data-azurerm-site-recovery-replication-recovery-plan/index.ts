...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.74.0/docs/data-sources/site_recovery_replication_recovery_plan
...
export class DataAzurermSiteRecoveryReplicationRecoveryPlan extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermSiteRecoveryReplicationRecoveryPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.74.0/docs/data-sources/site_recovery_replication_recovery_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.74.0/docs/data-sources/site_recovery_replication_recovery_plan azurerm_site_recovery_replication_recovery_plan} Data Source
  *
  * @param scope The scope in which to define this construct
