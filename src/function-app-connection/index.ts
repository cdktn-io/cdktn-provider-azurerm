...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/function_app_connection
...
export class FunctionAppConnectionAuthenticationOutputReference extends cdktn.ComplexObject {
...
export class FunctionAppConnectionSecretStoreOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class FunctionAppConnectionTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): FunctionAppConnectionTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: FunctionAppConnectionTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class FunctionAppConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FunctionAppConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/function_app_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_function_app_connection", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs/resources/function_app_connection azurerm_function_app_connection} Resource
  *
  * @param scope The scope in which to define this construct
