...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/resources/managed_redis
...
export class ManagedRedis extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedRedis that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/resources/managed_redis#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/resources/managed_redis azurerm_managed_redis} Resource
  *
  * @param scope The scope in which to define this construct
