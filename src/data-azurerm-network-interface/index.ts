...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/data-sources/network_interface
...
export class DataAzurermNetworkInterface extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNetworkInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.62.0/docs/data-sources/network_interface#import import section} in the documentation of this resource for the id to use
