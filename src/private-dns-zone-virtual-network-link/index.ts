...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.5.0/docs/resources/private_dns_zone_virtual_network_link
...
export class PrivateDnsZoneVirtualNetworkLink extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateDnsZoneVirtualNetworkLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.5.0/docs/resources/private_dns_zone_virtual_network_link#import import section} in the documentation of this resource for the id to use
