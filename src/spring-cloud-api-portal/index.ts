...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/resources/spring_cloud_api_portal
...
export class SpringCloudApiPortal extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpringCloudApiPortal that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.59.0/docs/resources/spring_cloud_api_portal#import import section} in the documentation of this resource for the id to use
