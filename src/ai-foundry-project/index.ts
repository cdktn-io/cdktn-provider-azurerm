...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.76.0/docs/resources/ai_foundry_project
...
export class AiFoundryProject extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AiFoundryProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.76.0/docs/resources/ai_foundry_project#import import section} in the documentation of this resource for the id to use
