...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/recovery_services_vault
...
export class DataAzurermRecoveryServicesVault extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermRecoveryServicesVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/recovery_services_vault#import import section} in the documentation of this resource for the id to use
