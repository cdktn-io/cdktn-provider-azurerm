...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/api_management_certificate
...
export interface ApiManagementCertificateAConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function apiManagementCertificateTimeoutsToTerraform(struct?: ApiManagementCertificateTimeouts | cdktn.IResolvable): any {
...
export function apiManagementCertificateTimeoutsToHclTerraform(struct?: ApiManagementCertificateTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ApiManagementCertificateTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementCertificateTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ApiManagementCertificateTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ApiManagementCertificateA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagementCertificateA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/api_management_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_api_management_certificate", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/api_management_certificate azurerm_api_management_certificate} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      key_vault_identity_client_id: cdktn.stringToTerraform(this._keyVaultIdentityClientId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      key_vault_identity_client_id: {
        value: cdktn.stringToHclTerraform(this._keyVaultIdentityClientId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
