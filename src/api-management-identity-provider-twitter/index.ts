...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/resources/api_management_identity_provider_twitter
...
export class ApiManagementIdentityProviderTwitter extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagementIdentityProviderTwitter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.71.0/docs/resources/api_management_identity_provider_twitter#import import section} in the documentation of this resource for the id to use
