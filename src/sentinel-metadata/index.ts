...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/sentinel_metadata
...
export class SentinelMetadata extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SentinelMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/sentinel_metadata#import import section} in the documentation of this resource for the id to use
