...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/advisor_suppression
...
export class AdvisorSuppression extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AdvisorSuppression that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/advisor_suppression#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/advisor_suppression azurerm_advisor_suppression} Resource
  *
  * @param scope The scope in which to define this construct
