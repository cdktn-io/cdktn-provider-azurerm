...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/virtual_desktop_application_group
...
export interface VirtualDesktopApplicationGroupConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function virtualDesktopApplicationGroupTimeoutsToTerraform(struct?: VirtualDesktopApplicationGroupTimeouts | cdktn.IResolvable): any {
...
export function virtualDesktopApplicationGroupTimeoutsToHclTerraform(struct?: VirtualDesktopApplicationGroupTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class VirtualDesktopApplicationGroupTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): VirtualDesktopApplicationGroupTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: VirtualDesktopApplicationGroupTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class VirtualDesktopApplicationGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualDesktopApplicationGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/virtual_desktop_application_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_virtual_desktop_application_group", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.79.0/docs/resources/virtual_desktop_application_group azurerm_virtual_desktop_application_group} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      default_desktop_display_name: cdktn.stringToTerraform(this._defaultDesktopDisplayName),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      default_desktop_display_name: {
        value: cdktn.stringToHclTerraform(this._defaultDesktopDisplayName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
