...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/virtual_desktop_host_pool
...
export interface DataAzurermVirtualDesktopHostPoolConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesScheduleOutputReference extends cdktn.ComplexObject {
...
export class DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesScheduleList extends cdktn.ComplexList {
...
export class DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAzurermVirtualDesktopHostPoolScheduledAgentUpdatesList extends cdktn.ComplexList {
...
export function dataAzurermVirtualDesktopHostPoolTimeoutsToTerraform(struct?: DataAzurermVirtualDesktopHostPoolTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAzurermVirtualDesktopHostPoolTimeoutsToHclTerraform(struct?: DataAzurermVirtualDesktopHostPoolTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAzurermVirtualDesktopHostPoolTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermVirtualDesktopHostPoolTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermVirtualDesktopHostPoolTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataAzurermVirtualDesktopHostPool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermVirtualDesktopHostPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/virtual_desktop_host_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.78.0/docs/data-sources/virtual_desktop_host_pool azurerm_virtual_desktop_host_pool} Data Source
  *
  * @param scope The scope in which to define this construct
