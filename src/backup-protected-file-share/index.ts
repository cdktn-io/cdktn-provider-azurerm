...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/backup_protected_file_share
...
export class BackupProtectedFileShare extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupProtectedFileShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.0.1/docs/resources/backup_protected_file_share#import import section} in the documentation of this resource for the id to use
