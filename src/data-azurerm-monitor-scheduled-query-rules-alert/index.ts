...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/data-sources/monitor_scheduled_query_rules_alert
...
export class DataAzurermMonitorScheduledQueryRulesAlert extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermMonitorScheduledQueryRulesAlert that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/data-sources/monitor_scheduled_query_rules_alert#import import section} in the documentation of this resource for the id to use
