...
// https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/stream_analytics_job
...
export class DataAzurermStreamAnalyticsJob extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermStreamAnalyticsJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.7.0/docs/data-sources/stream_analytics_job#import import section} in the documentation of this resource for the id to use
