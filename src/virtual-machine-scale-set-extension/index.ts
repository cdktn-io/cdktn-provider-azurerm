...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/virtual_machine_scale_set_extension
...
export class VirtualMachineScaleSetExtensionA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualMachineScaleSetExtensionA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.73.0/docs/resources/virtual_machine_scale_set_extension#import import section} in the documentation of this resource for the id to use
