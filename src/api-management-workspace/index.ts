...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/api_management_workspace
...
export interface ApiManagementWorkspaceConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function apiManagementWorkspaceTimeoutsToTerraform(struct?: ApiManagementWorkspaceTimeouts | cdktn.IResolvable): any {
...
export function apiManagementWorkspaceTimeoutsToHclTerraform(struct?: ApiManagementWorkspaceTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ApiManagementWorkspaceTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementWorkspaceTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ApiManagementWorkspaceTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ApiManagementWorkspace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagementWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/api_management_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/resources/api_management_workspace azurerm_api_management_workspace} Resource
  *
  * @param scope The scope in which to define this construct
