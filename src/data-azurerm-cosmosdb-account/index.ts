...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/data-sources/cosmosdb_account
...
export class DataAzurermCosmosdbAccount extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermCosmosdbAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.77.0/docs/data-sources/cosmosdb_account#import import section} in the documentation of this resource for the id to use
