...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/diskaccess"
...
&diskaccess.DiskAccessConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.diskAccess.DiskAccessTimeouts,
}
```
