...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/privatednsresolveroutboundendpoint"
...
&privatednsresolveroutboundendpoint.PrivateDnsResolverOutboundEndpointConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.privateDnsResolverOutboundEndpoint.PrivateDnsResolverOutboundEndpointTimeouts,
}
```
