...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/privatednsresolveroutboundendpoint"
...
&privatednsresolveroutboundendpoint.PrivateDnsResolverOutboundEndpointConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.privateDnsResolverOutboundEndpoint.PrivateDnsResolverOutboundEndpointTimeouts,
}
```
