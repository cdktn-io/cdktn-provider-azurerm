...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermlocation"
...
&dataazurermlocation.DataAzurermLocationConfig {
	...
	Location: *string,
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermLocation.DataAzurermLocationTimeouts,
}
```
