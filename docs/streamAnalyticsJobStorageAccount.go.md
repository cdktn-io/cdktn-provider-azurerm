...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/streamanalyticsjobstorageaccount"
...
&streamanalyticsjobstorageaccount.StreamAnalyticsJobStorageAccountConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.streamAnalyticsJobStorageAccount.StreamAnalyticsJobStorageAccountTimeouts,
}
```
