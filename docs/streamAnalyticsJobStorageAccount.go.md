...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/streamanalyticsjobstorageaccount"
...
&streamanalyticsjobstorageaccount.StreamAnalyticsJobStorageAccountConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18.streamAnalyticsJobStorageAccount.StreamAnalyticsJobStorageAccountTimeouts,
}
```
