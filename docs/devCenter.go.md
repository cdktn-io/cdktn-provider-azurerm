...
| <code><a href="#@cdktn/provider-azurerm.devCenter.DevCenterConfig.property.projectCatalogItemSyncEnabled">ProjectCatalogItemSyncEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/dev_center#project_catalog_item_sync_enabled DevCenter#project_catalog_item_sync_enabled}. |
| <code><a href="#@cdktn/provider-azurerm.devCenter.DevCenterConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/dev_center#tags DevCenter#tags}. |
