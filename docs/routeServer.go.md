...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/routeserver"
...
&routeserver.RouteServerConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.routeServer.RouteServerTimeouts,
}
```
