...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/cdnprofile"
...
&cdnprofile.CdnProfileConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.cdnProfile.CdnProfileTimeouts,
}
```
