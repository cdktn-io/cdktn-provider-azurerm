...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/automationdscconfiguration"
...
&automationdscconfiguration.AutomationDscConfigurationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.automationDscConfiguration.AutomationDscConfigurationTimeouts,
}
```
