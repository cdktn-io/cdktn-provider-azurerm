...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/automationdscconfiguration"
...
&automationdscconfiguration.AutomationDscConfigurationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.automationDscConfiguration.AutomationDscConfigurationTimeouts,
}
```
