...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermsharedimageversion"
...
&dataazurermsharedimageversion.DataAzurermSharedImageVersionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermSharedImageVersion.DataAzurermSharedImageVersionTimeouts,
}
```
