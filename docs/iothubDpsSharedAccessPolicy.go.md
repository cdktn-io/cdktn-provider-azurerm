...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/iothubdpssharedaccesspolicy"
...
&iothubdpssharedaccesspolicy.IothubDpsSharedAccessPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.iothubDpsSharedAccessPolicy.IothubDpsSharedAccessPolicyTimeouts,
}
```
