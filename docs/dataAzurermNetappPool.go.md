...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/netapp_pool#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-azurerm.dataAzurermNetappPool.DataAzurermNetappPoolConfig.property.accountName">AccountName</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/netapp_pool#account_name DataAzurermNetappPool#account_name}. |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermNetappPool.DataAzurermNetappPoolConfig.property.name">Name</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/netapp_pool#name DataAzurermNetappPool#name}. |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermNetappPool.DataAzurermNetappPoolConfig.property.resourceGroupName">ResourceGroupName</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/netapp_pool#resource_group_name DataAzurermNetappPool#resource_group_name}. |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermNetappPool.DataAzurermNetappPoolConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/netapp_pool#id DataAzurermNetappPool#id}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermNetappPool.DataAzurermNetappPoolTimeouts.property.read">Read</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.75.0/docs/data-sources/netapp_pool#read DataAzurermNetappPool#read}. |
