...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/synapseworkspacesecurityalertpolicy"
...
&synapseworkspacesecurityalertpolicy.SynapseWorkspaceSecurityAlertPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.synapseWorkspaceSecurityAlertPolicy.SynapseWorkspaceSecurityAlertPolicyTimeouts,
}
```
