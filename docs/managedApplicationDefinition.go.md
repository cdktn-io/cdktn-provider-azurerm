...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/managedapplicationdefinition"
...
&managedapplicationdefinition.ManagedApplicationDefinitionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.managedApplicationDefinition.ManagedApplicationDefinitionTimeouts,
}
```
