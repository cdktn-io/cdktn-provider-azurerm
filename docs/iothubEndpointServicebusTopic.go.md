...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/iothubendpointservicebustopic"
...
&iothubendpointservicebustopic.IothubEndpointServicebusTopicConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.iothubEndpointServicebusTopic.IothubEndpointServicebusTopicTimeouts,
}
```
