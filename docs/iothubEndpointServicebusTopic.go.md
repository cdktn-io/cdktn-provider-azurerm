...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/iothubendpointservicebustopic"
...
&iothubendpointservicebustopic.IothubEndpointServicebusTopicConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.iothubEndpointServicebusTopic.IothubEndpointServicebusTopicTimeouts,
}
```
