...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/netapppool"
...
&netapppool.NetappPoolConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.netappPool.NetappPoolTimeouts,
}
```
