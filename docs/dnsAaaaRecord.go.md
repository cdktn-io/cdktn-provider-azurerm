...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dnsaaaarecord"
...
&dnsaaaarecord.DnsAaaaRecordConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dnsAaaaRecord.DnsAaaaRecordTimeouts,
}
```
