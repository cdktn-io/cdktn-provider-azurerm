...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/devcenterdevboxdefinition"
...
&devcenterdevboxdefinition.DevCenterDevBoxDefinitionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.devCenterDevBoxDefinition.DevCenterDevBoxDefinitionTimeouts,
}
```
