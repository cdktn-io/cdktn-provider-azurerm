...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermstoragesync"
...
&dataazurermstoragesync.DataAzurermStorageSyncConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermStorageSync.DataAzurermStorageSyncTimeouts,
}
```
