...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/databoxedgedevice"
...
&databoxedgedevice.DataboxEdgeDeviceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.databoxEdgeDevice.DataboxEdgeDeviceTimeouts,
}
```
