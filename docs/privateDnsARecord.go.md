...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/privatednsarecord"
...
&privatednsarecord.PrivateDnsARecordConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.privateDnsARecord.PrivateDnsARecordTimeouts,
}
```
