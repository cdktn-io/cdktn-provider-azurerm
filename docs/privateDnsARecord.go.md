...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/privatednsarecord"
...
&privatednsarecord.PrivateDnsARecordConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.privateDnsARecord.PrivateDnsARecordTimeouts,
}
```
