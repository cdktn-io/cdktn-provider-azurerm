...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/privatednsarecord"
...
&privatednsarecord.PrivateDnsARecordConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16.privateDnsARecord.PrivateDnsARecordTimeouts,
}
```
