...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dnsarecord"
...
&dnsarecord.DnsARecordConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dnsARecord.DnsARecordTimeouts,
}
```
