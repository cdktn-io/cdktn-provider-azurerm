...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/synapseprivatelinkhub"
...
&synapseprivatelinkhub.SynapsePrivateLinkHubConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.synapsePrivateLinkHub.SynapsePrivateLinkHubTimeouts,
}
```
