...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/apiconnection"
...
&apiconnection.ApiConnectionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.apiConnection.ApiConnectionTimeouts,
}
```
