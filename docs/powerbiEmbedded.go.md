...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/powerbiembedded"
...
&powerbiembedded.PowerbiEmbeddedConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.powerbiEmbedded.PowerbiEmbeddedTimeouts,
}
```
