...
| <code><a href="#@cdktn/provider-azurerm.dataAzurermServicePlan.DataAzurermServicePlan.property.premiumPlanAutoScaleEnabled">PremiumPlanAutoScaleEnabled</a></code> | <code>Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public IResolvable PremiumPlanAutoScaleEnabled { get; }
```
