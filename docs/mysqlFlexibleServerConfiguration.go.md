...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/mysqlflexibleserverconfiguration"
...
&mysqlflexibleserverconfiguration.MysqlFlexibleServerConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.mysqlFlexibleServerConfiguration.MysqlFlexibleServerConfigurationTimeouts,
}
```
