...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/sentinelalertrulefusion"
...
&sentinelalertrulefusion.SentinelAlertRuleFusionConfig {
	...
	Name: *string,
	Source: interface{},
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.sentinelAlertRuleFusion.SentinelAlertRuleFusionTimeouts,
}
```
