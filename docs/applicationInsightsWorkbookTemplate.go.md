...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/applicationinsightsworkbooktemplate"
...
&applicationinsightsworkbooktemplate.ApplicationInsightsWorkbookTemplateConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.applicationInsightsWorkbookTemplate.ApplicationInsightsWorkbookTemplateTimeouts,
}
```
