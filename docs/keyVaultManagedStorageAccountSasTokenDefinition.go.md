...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/keyvaultmanagedstorageaccountsastokendefinition"
...
&keyvaultmanagedstorageaccountsastokendefinition.KeyVaultManagedStorageAccountSasTokenDefinitionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.keyVaultManagedStorageAccountSasTokenDefinition.KeyVaultManagedStorageAccountSasTokenDefinitionTimeouts,
}
```
