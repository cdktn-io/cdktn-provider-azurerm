...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/datafactorydatasetsnowflake"
...
&datafactorydatasetsnowflake.DataFactoryDatasetSnowflakeConfig {
	...
	SchemaName: *string,
	TableName: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataFactoryDatasetSnowflake.DataFactoryDatasetSnowflakeTimeouts,
}
```
