...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/eventgridpartnernamespace"
...
&eventgridpartnernamespace.EventgridPartnerNamespaceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.eventgridPartnerNamespace.EventgridPartnerNamespaceTimeouts,
}
```
