...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermservicebustopic"
...
&dataazurermservicebustopic.DataAzurermServicebusTopicConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermServicebusTopic.DataAzurermServicebusTopicTimeouts,
}
```
