...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/resourcepolicyremediation"
...
&resourcepolicyremediation.ResourcePolicyRemediationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.resourcePolicyRemediation.ResourcePolicyRemediationTimeouts,
}
```
