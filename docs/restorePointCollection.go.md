...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/restorepointcollection"
...
&restorepointcollection.RestorePointCollectionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15.restorePointCollection.RestorePointCollectionTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-azurerm.restorePointCollection.RestorePointCollectionConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.63.0/docs/resources/restore_point_collection#tags RestorePointCollection#tags}. |
