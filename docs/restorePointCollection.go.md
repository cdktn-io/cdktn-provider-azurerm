...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/restorepointcollection"
...
&restorepointcollection.RestorePointCollectionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.restorePointCollection.RestorePointCollectionTimeouts,
}
```
