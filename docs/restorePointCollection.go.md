...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/restorepointcollection"
...
&restorepointcollection.RestorePointCollectionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.restorePointCollection.RestorePointCollectionTimeouts,
}
```
