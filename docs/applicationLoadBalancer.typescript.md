...
| <code><a href="#@cdktn/provider-azurerm.applicationLoadBalancer.ApplicationLoadBalancerConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.69.0/docs/resources/application_load_balancer#tags ApplicationLoadBalancer#tags}. |
