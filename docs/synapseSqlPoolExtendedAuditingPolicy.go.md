...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/synapsesqlpoolextendedauditingpolicy"
...
&synapsesqlpoolextendedauditingpolicy.SynapseSqlPoolExtendedAuditingPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.synapseSqlPoolExtendedAuditingPolicy.SynapseSqlPoolExtendedAuditingPolicyTimeouts,
}
```
