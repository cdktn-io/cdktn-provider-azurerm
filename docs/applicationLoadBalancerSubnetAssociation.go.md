...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/applicationloadbalancersubnetassociation"
...
&applicationloadbalancersubnetassociation.ApplicationLoadBalancerSubnetAssociationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.applicationLoadBalancerSubnetAssociation.ApplicationLoadBalancerSubnetAssociationTimeouts,
}
```
