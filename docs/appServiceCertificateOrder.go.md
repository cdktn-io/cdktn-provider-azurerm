...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/appservicecertificateorder"
...
&appservicecertificateorder.AppServiceCertificateOrderConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.appServiceCertificateOrder.AppServiceCertificateOrderTimeouts,
	ValidityInYears: *f64,
}
```
