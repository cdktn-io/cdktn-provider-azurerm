...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/batchjob"
...
&batchjob.BatchJobConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.batchJob.BatchJobTimeouts,
}
```
