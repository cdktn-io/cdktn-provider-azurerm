...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/storageencryptionscope"
...
&storageencryptionscope.StorageEncryptionScopeConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.storageEncryptionScope.StorageEncryptionScopeTimeouts,
}
```
