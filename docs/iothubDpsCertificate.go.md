...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/iothubdpscertificate"
...
&iothubdpscertificate.IothubDpsCertificateConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.iothubDpsCertificate.IothubDpsCertificateTimeouts,
}
```
