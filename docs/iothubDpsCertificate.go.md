...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/iothubdpscertificate"
...
&iothubdpscertificate.IothubDpsCertificateConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.iothubDpsCertificate.IothubDpsCertificateTimeouts,
}
```
