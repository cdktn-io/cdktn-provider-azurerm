...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermstorageblob"
...
&dataazurermstorageblob.DataAzurermStorageBlobConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermStorageBlob.DataAzurermStorageBlobTimeouts,
}
```
