...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/applicationloadbalancer"
...
&applicationloadbalancer.ApplicationLoadBalancerConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.applicationLoadBalancer.ApplicationLoadBalancerTimeouts,
}
```
