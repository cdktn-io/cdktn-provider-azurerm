...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/resourcegrouppolicyremediation"
...
&resourcegrouppolicyremediation.ResourceGroupPolicyRemediationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.resourceGroupPolicyRemediation.ResourceGroupPolicyRemediationTimeouts,
}
```
