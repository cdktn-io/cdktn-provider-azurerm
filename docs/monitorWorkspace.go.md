...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/monitorworkspace"
...
&monitorworkspace.MonitorWorkspaceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.monitorWorkspace.MonitorWorkspaceTimeouts,
}
```
