...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/virtualmachinerestorepointcollection"
...
&virtualmachinerestorepointcollection.VirtualMachineRestorePointCollectionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.virtualMachineRestorePointCollection.VirtualMachineRestorePointCollectionTimeouts,
}
```
