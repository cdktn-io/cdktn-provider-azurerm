...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/dataazurermsubscription"
...
&dataazurermsubscription.DataAzurermSubscriptionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16.dataAzurermSubscription.DataAzurermSubscriptionTimeouts,
}
```
