...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermsubscription"
...
&dataazurermsubscription.DataAzurermSubscriptionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermSubscription.DataAzurermSubscriptionTimeouts,
}
```
