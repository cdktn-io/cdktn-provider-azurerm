...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/devcenterprojectpool"
...
&devcenterprojectpool.DevCenterProjectPoolConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.devCenterProjectPool.DevCenterProjectPoolTimeouts,
}
```
