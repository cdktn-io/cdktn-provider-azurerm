...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermservicebusqueue"
...
&dataazurermservicebusqueue.DataAzurermServicebusQueueConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermServicebusQueue.DataAzurermServicebusQueueTimeouts,
}
```
