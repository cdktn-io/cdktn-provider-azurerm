...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/postgresqlflexibleserverdatabase"
...
&postgresqlflexibleserverdatabase.PostgresqlFlexibleServerDatabaseConfig {
	...
	Collation: *string,
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.postgresqlFlexibleServerDatabase.PostgresqlFlexibleServerDatabaseTimeouts,
}
```
