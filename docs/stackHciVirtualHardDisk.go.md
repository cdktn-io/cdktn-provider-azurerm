...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/stackhcivirtualharddisk"
...
&stackhcivirtualharddisk.StackHciVirtualHardDiskConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.stackHciVirtualHardDisk.StackHciVirtualHardDiskTimeouts,
}
```
