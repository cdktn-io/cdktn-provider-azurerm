...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/virtualnetworkgatewaynatrule"
...
&virtualnetworkgatewaynatrule.VirtualNetworkGatewayNatRuleConfig {
	...
	Mode: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.virtualNetworkGatewayNatRule.VirtualNetworkGatewayNatRuleTimeouts,
	Type: *string,
}
```
