...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/servicebusnamespacecustomermanagedkey"
...
&servicebusnamespacecustomermanagedkey.ServicebusNamespaceCustomerManagedKeyAConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.servicebusNamespaceCustomerManagedKey.ServicebusNamespaceCustomerManagedKeyTimeouts,
}
```
