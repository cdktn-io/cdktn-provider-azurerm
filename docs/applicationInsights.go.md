...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/applicationinsights"
...
&applicationinsights.ApplicationInsightsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.applicationInsights.ApplicationInsightsTimeouts,
	WorkspaceId: *string,
}
```
