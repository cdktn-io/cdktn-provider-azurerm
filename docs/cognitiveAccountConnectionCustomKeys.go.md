...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/cognitiveaccountconnectioncustomkeys"
...
&cognitiveaccountconnectioncustomkeys.CognitiveAccountConnectionCustomKeysConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16.cognitiveAccountConnectionCustomKeys.CognitiveAccountConnectionCustomKeysTimeouts,
}
```
