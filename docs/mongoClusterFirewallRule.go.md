...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/mongoclusterfirewallrule"
...
&mongoclusterfirewallrule.MongoClusterFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.mongoClusterFirewallRule.MongoClusterFirewallRuleTimeouts,
}
```
