...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermactivedirectorydomainservice"
...
&dataazurermactivedirectorydomainservice.DataAzurermActiveDirectoryDomainServiceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermActiveDirectoryDomainService.DataAzurermActiveDirectoryDomainServiceTimeouts,
}
```
