...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/digitaltwinstimeseriesdatabaseconnection"
...
&digitaltwinstimeseriesdatabaseconnection.DigitalTwinsTimeSeriesDatabaseConnectionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.digitalTwinsTimeSeriesDatabaseConnection.DigitalTwinsTimeSeriesDatabaseConnectionTimeouts,
}
```
