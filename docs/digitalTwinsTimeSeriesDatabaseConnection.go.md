...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/digitaltwinstimeseriesdatabaseconnection"
...
&digitaltwinstimeseriesdatabaseconnection.DigitalTwinsTimeSeriesDatabaseConnectionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15.digitalTwinsTimeSeriesDatabaseConnection.DigitalTwinsTimeSeriesDatabaseConnectionTimeouts,
}
```
