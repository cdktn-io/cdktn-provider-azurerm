...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/publicipprefix"
...
&publicipprefix.PublicIpPrefixConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.publicIpPrefix.PublicIpPrefixTimeouts,
	Zones: *[]*string,
}
```
