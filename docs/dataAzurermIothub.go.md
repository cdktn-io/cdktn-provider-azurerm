...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermiothub"
...
&dataazurermiothub.DataAzurermIothubConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermIothub.DataAzurermIothubTimeouts,
}
```
