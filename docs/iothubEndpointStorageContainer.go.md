...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/iothubendpointstoragecontainer"
...
&iothubendpointstoragecontainer.IothubEndpointStorageContainerConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.iothubEndpointStorageContainer.IothubEndpointStorageContainerTimeouts,
}
```
