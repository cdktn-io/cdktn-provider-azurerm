...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/appservicemanagedcertificate"
...
&appservicemanagedcertificate.AppServiceManagedCertificateConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.appServiceManagedCertificate.AppServiceManagedCertificateTimeouts,
}
```
