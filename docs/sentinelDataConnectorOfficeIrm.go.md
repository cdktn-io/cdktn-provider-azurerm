...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/sentineldataconnectorofficeirm"
...
&sentineldataconnectorofficeirm.SentinelDataConnectorOfficeIrmConfig {
	...
	Id: *string,
	TenantId: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.sentinelDataConnectorOfficeIrm.SentinelDataConnectorOfficeIrmTimeouts,
}
```
