...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/nginxconfiguration"
...
&nginxconfiguration.NginxConfigurationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.nginxConfiguration.NginxConfigurationTimeouts,
}
```
