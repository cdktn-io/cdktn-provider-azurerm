...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/nginxconfiguration"
...
&nginxconfiguration.NginxConfigurationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18.nginxConfiguration.NginxConfigurationTimeouts,
}
```
