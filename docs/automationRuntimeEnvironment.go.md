...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/automationruntimeenvironment"
...
&automationruntimeenvironment.AutomationRuntimeEnvironmentConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.automationRuntimeEnvironment.AutomationRuntimeEnvironmentTimeouts,
}
```
