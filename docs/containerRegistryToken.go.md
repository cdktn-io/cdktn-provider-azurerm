...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/containerregistrytoken"
...
&containerregistrytoken.ContainerRegistryTokenConfig {
	...
	Enabled: interface{},
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.containerRegistryToken.ContainerRegistryTokenTimeouts,
}
```
