...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/privatednszonevirtualnetworklink"
...
&privatednszonevirtualnetworklink.PrivateDnsZoneVirtualNetworkLinkConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.privateDnsZoneVirtualNetworkLink.PrivateDnsZoneVirtualNetworkLinkTimeouts,
}
```
