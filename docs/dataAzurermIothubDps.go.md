...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermiothubdps"
...
&dataazurermiothubdps.DataAzurermIothubDpsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermIothubDps.DataAzurermIothubDpsTimeouts,
}
```
