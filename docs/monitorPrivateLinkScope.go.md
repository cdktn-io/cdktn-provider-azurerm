...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/monitorprivatelinkscope"
...
&monitorprivatelinkscope.MonitorPrivateLinkScopeConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.monitorPrivateLinkScope.MonitorPrivateLinkScopeTimeouts,
}
```
