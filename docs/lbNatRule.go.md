...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/lbnatrule"
...
&lbnatrule.LbNatRuleConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.lbNatRule.LbNatRuleTimeouts,
}
```
