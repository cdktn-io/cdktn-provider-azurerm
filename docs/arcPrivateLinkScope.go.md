...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/arcprivatelinkscope"
...
&arcprivatelinkscope.ArcPrivateLinkScopeConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.arcPrivateLinkScope.ArcPrivateLinkScopeTimeouts,
}
```
