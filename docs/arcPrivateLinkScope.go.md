...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/arcprivatelinkscope"
...
&arcprivatelinkscope.ArcPrivateLinkScopeConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.arcPrivateLinkScope.ArcPrivateLinkScopeTimeouts,
}
```
