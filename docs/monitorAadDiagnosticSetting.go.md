...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/monitoraaddiagnosticsetting"
...
&monitoraaddiagnosticsetting.MonitorAadDiagnosticSettingConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.monitorAadDiagnosticSetting.MonitorAadDiagnosticSettingTimeouts,
}
```
...
&monitoraaddiagnosticsetting.MonitorAadDiagnosticSettingEnabledLog {
	Category: *string,
	RetentionPolicy: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.monitorAadDiagnosticSetting.MonitorAadDiagnosticSettingEnabledLogRetentionPolicy,
}
```
