...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/botchannelslack"
...
&botchannelslack.BotChannelSlackConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18.botChannelSlack.BotChannelSlackTimeouts,
}
```
