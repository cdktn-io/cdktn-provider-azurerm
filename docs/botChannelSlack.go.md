...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/botchannelslack"
...
&botchannelslack.BotChannelSlackConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.botChannelSlack.BotChannelSlackTimeouts,
}
```
