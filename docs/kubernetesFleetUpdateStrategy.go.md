...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/kubernetesfleetupdatestrategy"
...
&kubernetesfleetupdatestrategy.KubernetesFleetUpdateStrategyConfig {
	...
	Stage: interface{},
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.kubernetesFleetUpdateStrategy.KubernetesFleetUpdateStrategyTimeouts,
}
```
