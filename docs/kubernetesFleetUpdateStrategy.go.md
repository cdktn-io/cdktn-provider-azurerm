...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/kubernetesfleetupdatestrategy"
...
&kubernetesfleetupdatestrategy.KubernetesFleetUpdateStrategyConfig {
	...
	Stage: interface{},
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18.kubernetesFleetUpdateStrategy.KubernetesFleetUpdateStrategyTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-azurerm.kubernetesFleetUpdateStrategy.KubernetesFleetUpdateStrategyStage.property.afterStageWaitInSeconds">AfterStageWaitInSeconds</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/resources/kubernetes_fleet_update_strategy#after_stage_wait_in_seconds KubernetesFleetUpdateStrategy#after_stage_wait_in_seconds}. |
