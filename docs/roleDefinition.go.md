...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/roledefinition"
...
&roledefinition.RoleDefinitionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.roleDefinition.RoleDefinitionTimeouts,
}
```
