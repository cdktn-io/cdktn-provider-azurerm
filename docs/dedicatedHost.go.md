...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dedicatedhost"
...
&dedicatedhost.DedicatedHostConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dedicatedHost.DedicatedHostTimeouts,
}
```
