...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/analysisservicesserver"
...
&analysisservicesserver.AnalysisServicesServerConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16.analysisServicesServer.AnalysisServicesServerTimeouts,
}
```
