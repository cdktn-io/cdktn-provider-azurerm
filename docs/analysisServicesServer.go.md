...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/analysisservicesserver"
...
&analysisservicesserver.AnalysisServicesServerConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.analysisServicesServer.AnalysisServicesServerTimeouts,
}
```
