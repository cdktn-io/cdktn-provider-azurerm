...
| <code><a href="#@cdktn/provider-azurerm.dataAzurermApiConnection.DataAzurermApiConnectionConfig.property.name">Name</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/api_connection#name DataAzurermApiConnection#name}. |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermApiConnection.DataAzurermApiConnectionConfig.property.resourceGroupName">ResourceGroupName</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/api_connection#resource_group_name DataAzurermApiConnection#resource_group_name}. |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermApiConnection.DataAzurermApiConnectionConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/api_connection#id DataAzurermApiConnection#id}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermApiConnection.DataAzurermApiConnectionTimeouts.property.read">Read</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs/data-sources/api_connection#read DataAzurermApiConnection#read}. |
