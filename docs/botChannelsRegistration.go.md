...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/botchannelsregistration"
...
&botchannelsregistration.BotChannelsRegistrationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.botChannelsRegistration.BotChannelsRegistrationTimeouts,
}
```
