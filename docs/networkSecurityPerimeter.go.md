...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/networksecurityperimeter"
...
&networksecurityperimeter.NetworkSecurityPerimeterConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.networkSecurityPerimeter.NetworkSecurityPerimeterTimeouts,
}
```
