...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/sharedimagegallery"
...
&sharedimagegallery.SharedImageGalleryConfig {
	...
	Description: *string,
	Id: *string,
	Sharing: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.sharedImageGallery.SharedImageGallerySharing,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.sharedImageGallery.SharedImageGalleryTimeouts,
}
```
...
&sharedimagegallery.SharedImageGallerySharing {
	Permission: *string,
	CommunityGallery: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.sharedImageGallery.SharedImageGallerySharingCommunityGallery,
}
```
