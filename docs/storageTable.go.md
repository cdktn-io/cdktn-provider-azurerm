...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/storagetable"
...
&storagetable.StorageTableConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.storageTable.StorageTableTimeouts,
}
```
