...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/storagetable"
...
&storagetable.StorageTableConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16.storageTable.StorageTableTimeouts,
}
```
