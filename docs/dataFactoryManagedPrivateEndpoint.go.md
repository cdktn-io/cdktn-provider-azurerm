...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/datafactorymanagedprivateendpoint"
...
&datafactorymanagedprivateendpoint.DataFactoryManagedPrivateEndpointConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataFactoryManagedPrivateEndpoint.DataFactoryManagedPrivateEndpointTimeouts,
}
```
