...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/privatednsptrrecord"
...
&privatednsptrrecord.PrivateDnsPtrRecordConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.privateDnsPtrRecord.PrivateDnsPtrRecordTimeouts,
}
```
