...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/redisenterprisecluster"
...
&redisenterprisecluster.RedisEnterpriseClusterConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.redisEnterpriseCluster.RedisEnterpriseClusterTimeouts,
	Zones: *[]*string,
}
```
