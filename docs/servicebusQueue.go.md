...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/servicebusqueue"
...
&servicebusqueue.ServicebusQueueConfig {
	...
	Status: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.servicebusQueue.ServicebusQueueTimeouts,
}
```
