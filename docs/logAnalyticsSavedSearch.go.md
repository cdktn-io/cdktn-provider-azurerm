...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/loganalyticssavedsearch"
...
&loganalyticssavedsearch.LogAnalyticsSavedSearchConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.logAnalyticsSavedSearch.LogAnalyticsSavedSearchTimeouts,
}
```
