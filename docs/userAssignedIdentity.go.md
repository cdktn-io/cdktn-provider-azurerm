...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/userassignedidentity"
...
&userassignedidentity.UserAssignedIdentityConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18.userAssignedIdentity.UserAssignedIdentityTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-azurerm.userAssignedIdentity.UserAssignedIdentityConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.1.0/docs/resources/user_assigned_identity#tags UserAssignedIdentity#tags}. |
