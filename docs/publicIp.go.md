...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/publicip"
...
&publicip.PublicIpConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.publicIp.PublicIpTimeouts,
	Zones: *[]*string,
}
```
