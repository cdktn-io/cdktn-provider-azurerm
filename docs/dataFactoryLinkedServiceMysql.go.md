...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/datafactorylinkedservicemysql"
...
&datafactorylinkedservicemysql.DataFactoryLinkedServiceMysqlConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18.dataFactoryLinkedServiceMysql.DataFactoryLinkedServiceMysqlTimeouts,
}
```
