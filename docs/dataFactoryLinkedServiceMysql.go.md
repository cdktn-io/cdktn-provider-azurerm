...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/datafactorylinkedservicemysql"
...
&datafactorylinkedservicemysql.DataFactoryLinkedServiceMysqlConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataFactoryLinkedServiceMysql.DataFactoryLinkedServiceMysqlTimeouts,
}
```
