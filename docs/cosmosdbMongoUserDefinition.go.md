...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/cosmosdbmongouserdefinition"
...
&cosmosdbmongouserdefinition.CosmosdbMongoUserDefinitionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18.cosmosdbMongoUserDefinition.CosmosdbMongoUserDefinitionTimeouts,
}
```
