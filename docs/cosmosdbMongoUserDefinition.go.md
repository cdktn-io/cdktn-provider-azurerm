...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/cosmosdbmongouserdefinition"
...
&cosmosdbmongouserdefinition.CosmosdbMongoUserDefinitionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.cosmosdbMongoUserDefinition.CosmosdbMongoUserDefinitionTimeouts,
}
```
