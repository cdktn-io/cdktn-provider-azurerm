...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/cosmosdbmongouserdefinition"
...
&cosmosdbmongouserdefinition.CosmosdbMongoUserDefinitionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15.cosmosdbMongoUserDefinition.CosmosdbMongoUserDefinitionTimeouts,
}
```
