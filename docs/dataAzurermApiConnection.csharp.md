...
Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection azurerm_api_connection}.
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-azurerm.dataAzurermApiConnection.DataAzurermApiConnectionConfig.property.name">Name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection#name DataAzurermApiConnection#name}. |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermApiConnection.DataAzurermApiConnectionConfig.property.resourceGroupName">ResourceGroupName</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection#resource_group_name DataAzurermApiConnection#resource_group_name}. |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermApiConnection.DataAzurermApiConnectionConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection#id DataAzurermApiConnection#id}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection#name DataAzurermApiConnection#name}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection#resource_group_name DataAzurermApiConnection#resource_group_name}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection#id DataAzurermApiConnection#id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection#timeouts DataAzurermApiConnection#timeouts}
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermApiConnection.DataAzurermApiConnectionTimeouts.property.read">Read</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection#read DataAzurermApiConnection#read}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.3.0/docs/data-sources/api_connection#read DataAzurermApiConnection#read}.
