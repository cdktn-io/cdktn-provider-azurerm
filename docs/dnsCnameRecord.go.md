...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dnscnamerecord"
...
&dnscnamerecord.DnsCnameRecordConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dnsCnameRecord.DnsCnameRecordTimeouts,
}
```
