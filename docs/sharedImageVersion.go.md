...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/sharedimageversion"
...
&sharedimageversion.SharedImageVersionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.sharedImageVersion.SharedImageVersionTimeouts,
}
```
