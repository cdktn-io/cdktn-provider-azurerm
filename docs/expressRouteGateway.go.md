...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/expressroutegateway"
...
&expressroutegateway.ExpressRouteGatewayConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.expressRouteGateway.ExpressRouteGatewayTimeouts,
}
```
