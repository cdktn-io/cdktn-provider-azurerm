...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/expressroutegateway"
...
&expressroutegateway.ExpressRouteGatewayConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.expressRouteGateway.ExpressRouteGatewayTimeouts,
}
```
