...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/storagequeue"
...
&storagequeue.StorageQueueConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.storageQueue.StorageQueueTimeouts,
}
```
