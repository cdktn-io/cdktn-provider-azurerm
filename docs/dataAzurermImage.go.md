...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermimage"
...
&dataazurermimage.DataAzurermImageConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermImage.DataAzurermImageTimeouts,
}
```
