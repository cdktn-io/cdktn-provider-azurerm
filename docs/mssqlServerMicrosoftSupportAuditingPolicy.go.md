...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/mssqlservermicrosoftsupportauditingpolicy"
...
&mssqlservermicrosoftsupportauditingpolicy.MssqlServerMicrosoftSupportAuditingPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.mssqlServerMicrosoftSupportAuditingPolicy.MssqlServerMicrosoftSupportAuditingPolicyTimeouts,
}
```
