...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/virtualdesktopworkspace"
...
&virtualdesktopworkspace.VirtualDesktopWorkspaceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.virtualDesktopWorkspace.VirtualDesktopWorkspaceTimeouts,
}
```
