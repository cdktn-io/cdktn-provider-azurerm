...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/datafactorydatasetazureblob"
...
&datafactorydatasetazureblob.DataFactoryDatasetAzureBlobConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18.dataFactoryDatasetAzureBlob.DataFactoryDatasetAzureBlobTimeouts,
}
```
