...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/storagecontainerimmutabilitypolicy"
...
&storagecontainerimmutabilitypolicy.StorageContainerImmutabilityPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.storageContainerImmutabilityPolicy.StorageContainerImmutabilityPolicyTimeouts,
}
```
