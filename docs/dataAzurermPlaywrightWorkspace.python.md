...
| <code><a href="#@cdktn/provider-azurerm.dataAzurermPlaywrightWorkspace.DataAzurermPlaywrightWorkspace.Initializer.parameter.name">name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/data-sources/playwright_workspace#name DataAzurermPlaywrightWorkspace#name}. |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermPlaywrightWorkspace.DataAzurermPlaywrightWorkspace.Initializer.parameter.resourceGroupName">resource_group_name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/data-sources/playwright_workspace#resource_group_name DataAzurermPlaywrightWorkspace#resource_group_name}. |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermPlaywrightWorkspace.DataAzurermPlaywrightWorkspace.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/data-sources/playwright_workspace#id DataAzurermPlaywrightWorkspace#id}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-azurerm.dataAzurermPlaywrightWorkspace.DataAzurermPlaywrightWorkspaceTimeouts.property.read">read</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/5.4.0/docs/data-sources/playwright_workspace#read DataAzurermPlaywrightWorkspace#read}. |
