...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/roleassignment"
...
&roleassignment.RoleAssignmentConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.roleAssignment.RoleAssignmentTimeouts,
}
```
