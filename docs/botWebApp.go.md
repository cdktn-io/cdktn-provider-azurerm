...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/botwebapp"
...
&botwebapp.BotWebAppConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.botWebApp.BotWebAppTimeouts,
}
```
