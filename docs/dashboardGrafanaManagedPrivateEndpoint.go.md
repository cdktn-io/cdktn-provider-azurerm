...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dashboardgrafanamanagedprivateendpoint"
...
&dashboardgrafanamanagedprivateendpoint.DashboardGrafanaManagedPrivateEndpointConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dashboardGrafanaManagedPrivateEndpoint.DashboardGrafanaManagedPrivateEndpointTimeouts,
}
```
