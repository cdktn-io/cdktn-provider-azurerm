...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/iotcentralorganization"
...
&iotcentralorganization.IotcentralOrganizationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18.iotcentralOrganization.IotcentralOrganizationTimeouts,
}
```
