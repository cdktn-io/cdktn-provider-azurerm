...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/iotcentralorganization"
...
&iotcentralorganization.IotcentralOrganizationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.iotcentralOrganization.IotcentralOrganizationTimeouts,
}
```
