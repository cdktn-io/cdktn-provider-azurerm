...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/mssqldatabaseextendedauditingpolicy"
...
&mssqldatabaseextendedauditingpolicy.MssqlDatabaseExtendedAuditingPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.mssqlDatabaseExtendedAuditingPolicy.MssqlDatabaseExtendedAuditingPolicyTimeouts,
}
```
