...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/cosmosdbsqldedicatedgateway"
...
&cosmosdbsqldedicatedgateway.CosmosdbSqlDedicatedGatewayConfig {
	...
	InstanceSize: *string,
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.cosmosdbSqlDedicatedGateway.CosmosdbSqlDedicatedGatewayTimeouts,
}
```
