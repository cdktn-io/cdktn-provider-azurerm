...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/systemcentervirtualmachinemanageravailabilityset"
...
&systemcentervirtualmachinemanageravailabilityset.SystemCenterVirtualMachineManagerAvailabilitySetConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.systemCenterVirtualMachineManagerAvailabilitySet.SystemCenterVirtualMachineManagerAvailabilitySetTimeouts,
}
```
