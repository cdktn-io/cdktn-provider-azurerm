...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/oracleexadatainfrastructure"
...
&oracleexadatainfrastructure.OracleExadataInfrastructureConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.oracleExadataInfrastructure.OracleExadataInfrastructureTimeouts,
}
```
