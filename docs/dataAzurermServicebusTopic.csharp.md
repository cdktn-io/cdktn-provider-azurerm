...
| <code><a href="#@cdktn/provider-azurerm.dataAzurermServicebusTopic.DataAzurermServicebusTopic.property.maximumMessageSizeInKb">MaximumMessageSizeInKb</a></code> | <code>double</code> | *No description.* |
