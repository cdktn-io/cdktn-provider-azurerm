...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/eventgridpartnerregistration"
...
&eventgridpartnerregistration.EventgridPartnerRegistrationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.eventgridPartnerRegistration.EventgridPartnerRegistrationTimeouts,
}
```
