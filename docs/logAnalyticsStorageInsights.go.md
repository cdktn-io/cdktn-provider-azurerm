...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/loganalyticsstorageinsights"
...
&loganalyticsstorageinsights.LogAnalyticsStorageInsightsConfig {
	...
	Id: *string,
	TableNames: *[]*string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.logAnalyticsStorageInsights.LogAnalyticsStorageInsightsTimeouts,
}
```
