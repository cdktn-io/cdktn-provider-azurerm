...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/devtestpolicy"
...
&devtestpolicy.DevTestPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15.devTestPolicy.DevTestPolicyTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-azurerm.devTestPolicy.DevTestPolicyConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.64.0/docs/resources/dev_test_policy#tags DevTestPolicy#tags}. |
