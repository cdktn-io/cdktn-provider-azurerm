...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/devtestpolicy"
...
&devtestpolicy.DevTestPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.devTestPolicy.DevTestPolicyTimeouts,
}
```
