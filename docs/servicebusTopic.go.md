...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/servicebustopic"
...
&servicebustopic.ServicebusTopicConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.servicebusTopic.ServicebusTopicTimeouts,
}
```
