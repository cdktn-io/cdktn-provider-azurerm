...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/eventgridpartnerconfiguration"
...
&eventgridpartnerconfiguration.EventgridPartnerConfigurationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.eventgridPartnerConfiguration.EventgridPartnerConfigurationTimeouts,
}
```
