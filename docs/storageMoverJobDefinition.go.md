...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/storagemoverjobdefinition"
...
&storagemoverjobdefinition.StorageMoverJobDefinitionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.storageMoverJobDefinition.StorageMoverJobDefinitionTimeouts,
}
```
