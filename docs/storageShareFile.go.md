...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/storagesharefile"
...
&storagesharefile.StorageShareFileConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.storageShareFile.StorageShareFileTimeouts,
}
```
