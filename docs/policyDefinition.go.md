...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/policydefinition"
...
&policydefinition.PolicyDefinitionConfig {
	...
	Parameters: *string,
	PolicyRule: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.policyDefinition.PolicyDefinitionTimeouts,
}
```
