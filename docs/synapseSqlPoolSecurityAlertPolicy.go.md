...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/synapsesqlpoolsecurityalertpolicy"
...
&synapsesqlpoolsecurityalertpolicy.SynapseSqlPoolSecurityAlertPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.synapseSqlPoolSecurityAlertPolicy.SynapseSqlPoolSecurityAlertPolicyTimeouts,
}
```
