...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15/synapsesqlpoolsecurityalertpolicy"
...
&synapsesqlpoolsecurityalertpolicy.SynapseSqlPoolSecurityAlertPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v15.synapseSqlPoolSecurityAlertPolicy.SynapseSqlPoolSecurityAlertPolicyTimeouts,
}
```
