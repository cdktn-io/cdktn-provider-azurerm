...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17/synapsesqlpoolsecurityalertpolicy"
...
&synapsesqlpoolsecurityalertpolicy.SynapseSqlPoolSecurityAlertPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v17.synapseSqlPoolSecurityAlertPolicy.SynapseSqlPoolSecurityAlertPolicyTimeouts,
}
```
