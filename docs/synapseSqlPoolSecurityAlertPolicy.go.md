...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18/synapsesqlpoolsecurityalertpolicy"
...
&synapsesqlpoolsecurityalertpolicy.SynapseSqlPoolSecurityAlertPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v18.synapseSqlPoolSecurityAlertPolicy.SynapseSqlPoolSecurityAlertPolicyTimeouts,
}
```
