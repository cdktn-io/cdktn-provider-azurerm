...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermdatabricksworkspace"
...
&dataazurermdatabricksworkspace.DataAzurermDatabricksWorkspaceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermDatabricksWorkspace.DataAzurermDatabricksWorkspaceTimeouts,
}
```
