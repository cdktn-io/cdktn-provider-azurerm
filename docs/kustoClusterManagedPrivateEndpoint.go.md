...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/kustoclustermanagedprivateendpoint"
...
&kustoclustermanagedprivateendpoint.KustoClusterManagedPrivateEndpointConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.kustoClusterManagedPrivateEndpoint.KustoClusterManagedPrivateEndpointTimeouts,
}
```
