...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/datafactorydatasetcosmosdbsqlapi"
...
&datafactorydatasetcosmosdbsqlapi.DataFactoryDatasetCosmosdbSqlapiConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataFactoryDatasetCosmosdbSqlapi.DataFactoryDatasetCosmosdbSqlapiTimeouts,
}
```
