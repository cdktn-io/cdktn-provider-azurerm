...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/dataazurermnetappvolume"
...
&dataazurermnetappvolume.DataAzurermNetappVolumeConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.dataAzurermNetappVolume.DataAzurermNetappVolumeTimeouts,
}
```
