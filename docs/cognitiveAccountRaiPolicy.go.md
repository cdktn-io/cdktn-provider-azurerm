...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/cognitiveaccountraipolicy"
...
&cognitiveaccountraipolicy.CognitiveAccountRaiPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.cognitiveAccountRaiPolicy.CognitiveAccountRaiPolicyTimeouts,
}
```
