...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/storageaccountlocaluser"
...
&storageaccountlocaluser.StorageAccountLocalUserConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.storageAccountLocalUser.StorageAccountLocalUserTimeouts,
}
```
...
&storageaccountlocaluser.StorageAccountLocalUserPermissionScope {
	Permissions: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.storageAccountLocalUser.StorageAccountLocalUserPermissionScopePermissions,
	ResourceName: *string,
	Service: *string,
}
```
