...
| <code><a href="#@cdktn/provider-azurerm.dataAzurermIothub.DataAzurermIothubConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.80.0/docs/data-sources/iothub#tags DataAzurermIothub#tags}. |
