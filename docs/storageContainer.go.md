...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/storagecontainer"
...
&storagecontainer.StorageContainerConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.storageContainer.StorageContainerTimeouts,
}
```
