...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16/advisorsuppression"
...
&advisorsuppression.AdvisorSuppressionConfig {
	...
	ResourceId: *string,
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/v16.advisorSuppression.AdvisorSuppressionTimeouts,
	Ttl: *string,
}
```
