...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/advisorsuppression"
...
&advisorsuppression.AdvisorSuppressionConfig {
	...
	ResourceId: *string,
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.advisorSuppression.AdvisorSuppressionTimeouts,
	Ttl: *string,
}
```
