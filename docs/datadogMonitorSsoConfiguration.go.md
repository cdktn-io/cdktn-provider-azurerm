...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/datadogmonitorssoconfiguration"
...
&datadogmonitorssoconfiguration.DatadogMonitorSsoConfigurationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.datadogMonitorSsoConfiguration.DatadogMonitorSsoConfigurationTimeouts,
}
```
