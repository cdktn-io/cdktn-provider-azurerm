...
```go
import "github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm/paloaltolocalrulestackcertificate"
...
&paloaltolocalrulestackcertificate.PaloAltoLocalRulestackCertificateConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-azurerm-go/azurerm.paloAltoLocalRulestackCertificate.PaloAltoLocalRulestackCertificateTimeouts,
}
```
