...
# CDKTN prebuilt bindings for hashicorp/azurerm provider version 4.65.0

This repo builds and publishes the [Terraform azurerm provider](https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform azurerm provider](https://registry.terraform.io/providers/hashicorp/azurerm/4.65.0)
