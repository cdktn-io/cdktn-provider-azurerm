...
# CDKTN prebuilt bindings for hashicorp/azurerm provider version 4.70.0

This repo builds and publishes the [Terraform azurerm provider](https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform azurerm provider](https://registry.terraform.io/providers/hashicorp/azurerm/4.70.0)
